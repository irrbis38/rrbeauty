...
function doHeaderInit(){const t=document.querySelector(".header__container"),n=document.querySelector(".header__menu"),e=document.querySelector(".header__btn");function o(){t.classList.contains("active")?(t.classList.remove("active"),n.style.maxHeight=0):(t.classList.add("active"),n.style.maxHeight=n.scrollHeight+"px",n.style.opacity=1)}e.addEventListener("click",()=>{requestAnimationFrame(o)});const r=window.matchMedia("(max-width: 1300px)");r.addEventListener("change",function(e){e.matches?(n.style.maxHeight=0,n.style.opacity=0):(t.classList.remove("active"),n.style.maxHeight=n.scrollHeight+"px",n.style.opacity=1)})}function doPanelInit(){const e=document.querySelectorAll(".panel__input"),t=document.querySelectorAll(".panel__clear");function n(e){const t=e.nextElementSibling;e.value="",e.classList.remove("active"),t.classList.remove("visible")}e.forEach(e=>e.addEventListener("input",r=>requestAnimationFrame(()=>{{var e=r;const t=Boolean(e.target.value),n=e.target,o=n.nextElementSibling;return void(t?(n.classList.add("active"),o.classList.add("visible")):(n.classList.remove("active"),o.classList.remove("visible")))}}))),t.forEach(e=>e.addEventListener("click",o=>requestAnimationFrame(()=>{{var e;const t=o.target.closest(".panel__clear"),n=t.previousElementSibling;return n.value="",n.classList.remove("active"),n.focus(),void t.classList.remove("visible")}})));const o=document.body,r=document.getElementById("show-menu"),s=document.getElementById("menu-overlay"),i=document.getElementById("menu"),l=document.querySelector(".panel__showCategories");r.addEventListener("click",()=>{requestAnimationFrame(()=>{[s,i,l].forEach(e=>e.classList.toggle("active")),o.classList.toggle("lock"),e.forEach(e=>n(e))})}),s.addEventListener("click",()=>{requestAnimationFrame(()=>{[s,i,l].forEach(e=>e.classList.remove("active")),o.classList.remove("lock"),e.forEach(e=>n(e))})})}function initAutoscrollBlocks(){const e=document.querySelector(".brandsSection__autoscroll"),t=document.querySelector(".promotionsSection__autoscroll"),n=document.querySelector(".map__autoscroll");[e].forEach(e=>{new Splide(e,{type:"loop",arrows:!1,pagination:!1,perPage:3,gap:"800px",breakpoints:{1700:{gap:"900px"},1600:{gap:"400px"},1400:{gap:"600px"},992:{gap:"200px",perPage:2},767:{perPage:3,gap:"100px"},650:{gap:"150px"},575:{perPage:2,gap:"100px"},400:{gap:"170px"}},autoScroll:{speed:1,pauseOnHover:!1,pauseOnFocus:!1}}).mount(window.splide.Extensions)}),[t].forEach(e=>{new Splide(e,{type:"loop",arrows:!1,pagination:!1,perPage:3,gap:"400px",breakpoints:{1700:{gap:"600px"},1600:{gap:"200px"},1300:{gap:"300px"},1150:{gap:"500px"},992:{gap:"350px"},767:{gap:"60px"},575:{gap:"230px"}},autoScroll:{speed:1,pauseOnHover:!1,pauseOnFocus:!1}}).mount(window.splide.Extensions)}),[n].forEach(e=>{new Splide(e,{type:"loop",arrows:!1,pagination:!1,perPage:2,gap:"1700px",breakpoints:{1600:{gap:"1000px"},1400:{gap:"1100px"},1300:{gap:"1200px"},1100:{gap:"1250px"},992:{gap:"950px"},767:{gap:"500px"}},autoScroll:{speed:1,pauseOnHover:!1,pauseOnFocus:!1}}).mount(window.splide.Extensions)})}async function doInitMap(){ymaps.ready(function(){var t=[51.158562572612595,71.43921449999996];if(ymaps){let e=new ymaps.Map("map-section-wrapper",{center:t,zoom:17});t=new ymaps.Placemark(t,{},{iconLayout:"default#image",iconImageHref:"images/map-current-mark.svg",iconImageSize:[40,40],iconImageOffset:[-15,-5]});e.controls.remove("geolocationControl"),e.controls.remove("searchControl"),e.controls.remove("trafficControl"),e.controls.remove("typeSelector"),e.controls.remove("fullscreenControl"),e.controls.remove("zoomControl"),e.controls.remove("rulerControl"),e.geoObjects.add(t)}})}function doRemoveMapOverlayByClick(){const e=document.querySelector(".mapSection__overlay");e.addEventListener("click",()=>{e.classList.add("hidden")})}function doInitMapStoresSelect(){var e=document.querySelector(".map__stores");new Choices(e,{silent:!1,searchEnabled:!1})}function doAddMapStoresListener(){const e=document.querySelector(".map__stores"),t=document.querySelector(".map__description");e.addEventListener("change",e=>{t.classList.remove("hidden")})}function doHideMapDescription(){const e=document.querySelector(".map__description"),t=document.querySelector(".map__close");t.addEventListener("click",()=>{e.classList.add("hidden")})}function doToggleFooterAccordion(){window.innerWidth<=575&&doAddListenersToFooterAccordions();const e=window.matchMedia("(max-width: 575px)");e.addEventListener("change",e=>{(e.matches?doAddListenersToFooterAccordions:doRemoveListenersToFooterAccordions)()})}function handleFooterAccordions(e){const t=e.target.closest(".footer__column"),n=t.children[1];t.classList.toggle("active");e=t.classList.contains("active");n.style.maxHeight=e?n.scrollHeight+"px":null}function doAddListenersToFooterAccordions(){const e=document.querySelectorAll(".footer__column");e.forEach(e=>{const t=e.children[0];t.addEventListener("click",handleFooterAccordions)})}function doRemoveListenersToFooterAccordions(){const e=document.querySelectorAll(".footer__column");e.forEach(e=>{const t=e.children[0],n=e.children[1];t.removeEventListener("click",handleFooterAccordions),e.classList.remove("active"),n.style.maxHeight=null})}function doToggleFavoritesIcons(){const e=document.querySelectorAll(".goodsCard__addToFavorites");e.forEach(e=>e.addEventListener("click",e=>{const t=e.target.closest(".goodsCard__item");t.classList.toggle("addedToFavorites")}))}function doSortMenuLogic(){const e=document.body,o=document.querySelector(".options__sortToggleBtn");var t=document.querySelector(".options__overlay");const n=Array.from(document.querySelectorAll(".options__sortList li button")),r=[].concat(t,...n),s=document.querySelector(".options__current");function i(){e.classList.remove("sort-list-open"),r.forEach(e=>e.removeEventListener("click",i))}function l(e){var t=o.dataset.sortType,e=e.target.closest(".options__sortList button"),n=e.dataset.sortType;t!==n&&(s.textContent=e.children[0].textContent,o.dataset.sortType=n)}o.addEventListener("click",()=>{e.classList.add("sort-list-open"),r.forEach(e=>e.addEventListener("click",i)),n.forEach(e=>e.addEventListener("click",l))})}function doFiltersMenuLogic(){const e=document.querySelector(".options__nav"),t=document.querySelector(".options__filtersToggleBtn"),n=Array.from(document.querySelectorAll(".filters__button")),o=document.querySelector(".filters");t.addEventListener("click",()=>{e.classList.toggle("filters-opened"),o.classList.toggle("filters-opened")}),n.forEach(n=>n.addEventListener("click",()=>{const e=n.closest(".filters__block"),t=e.querySelector(".filters__wrapper");e.classList.toggle("filters-block-opened"),e.classList.contains("filters-block-opened")?t.style.maxHeight=t.scrollHeight+"px":t.style.maxHeight=null}))}function handleAllInputRange(){const e=document.querySelectorAll(".filters__range");function t(e){let t,n;var o=e.target.classList.contains("filters__inputMin"),r=e.target.classList.contains("filters__inputMax");o?(t=e.target,n=t.nextElementSibling):r&&(n=e.target,t=n.previousElementSibling);const s=t.closest(".filters__wrapper"),i=s.querySelector(".filters__track"),l=s.querySelector(".filters__valueMin"),a=s.querySelector(".filters__valueMax");var r=parseInt(t.value),e=parseInt(n.value);let c;c=parseInt(n.max)-parseInt(t.min)<=10?1:parseInt(n.max)-parseInt(t.min)<=100?10:50,e-r<c?o?t.value=e-c:n.value=r+c:(l.value=""+r,a.value=""+e,o=100*(r-t.min)/(t.max-t.min)+"%",r=100*(n.max-e)/(n.max-n.min)+"%",i.style.left=o,i.style.right=r)}e.forEach(e=>e.addEventListener("input",t));const n=Array.from(document.querySelectorAll(".filters__valueMin")),o=Array.from(document.querySelectorAll(".filters__valueMax"));function r(e){const t=e.target,n=t.closest(".filters__wrapper"),o=n.querySelector(".filters__inputMin"),r=n.querySelector(".filters__inputMax");var e=t.classList.contains("filters__valueMin"),s=t.classList.contains("filters__valueMax");const i=n.querySelector(".filters__track");let l,a=(l=r.max-o.min<=10?1:r.max-o.min<=100?10:50,parseInt(t.value));function c(){var e=100*(a-o.min)/(o.max-o.min)+"%";i.style.left=e}function d(){var e=100*(r.max-a)/(r.max-r.min)+"%";i.style.right=e}e&&(a<t.min||Number.isNaN(a)?(t.value="",o.value=parseInt(t.min),i.style.left=0):(a>r.value-l?(t.value=parseInt(r.value)-l,o.value=parseInt(r.value)-l):(t.value=a,o.value=a),c())),s&&(a>parseInt(t.max)||Number.isNaN(a)?(t.value="",r.value=parseInt(t.max),i.style.right="0"):(a<parseInt(o.value)+l?(t.value=parseInt(o.value)+l,r.value=parseInt(o.value)+l):(t.value=a,r.value=a),d()))}n.forEach(e=>e.addEventListener("change",r)),o.forEach(e=>e.addEventListener("change",r)),n.forEach(e=>e.addEventListener("blur",r)),o.forEach(e=>e.addEventListener("blur",r))}function doToggleBrandDescription(){const e=document.querySelector(".brandDescription"),t=document.querySelector(".brandDescription__title"),n=document.querySelector(".brandDescription__info");t.addEventListener("click",()=>{e.classList.toggle("brand-description-opened"),e.classList.contains("brand-description-opened")?n.style.maxHeight=n.scrollHeight+"px":n.style.maxHeight=null})}function initParallaxPromotionsSection(){const e=document.querySelector(".discountedProducts"),n=e.querySelectorAll(".goodsCard__item");let t=gsap.matchMedia();t.add({isDesktop:"(min-width: 992px) and (prefers-reduced-motion: no-preference)",isMobile:"(max-width: 991px) and (prefers-reduced-motion: no-preference)"},e=>{e=e.conditions.isDesktop;const t=gsap.timeline();return e&&t.from(n[0],{y:"-232px",ease:Power2.easeOut,scrollTrigger:{trigger:".goodsCard__wrapper",start:"+=200px bottom",end:"bottom+=400px bottom",scrub:!0}},0).from(n[2],{y:"-98px",ease:Power2.easeOut,scrollTrigger:{trigger:".goodsCard__wrapper",start:"+=200px bottom",end:"bottom+=200px bottom",scrub:!0}},0),()=>{}})}function initAnimateTextPromotionsSection(){let e=gsap.matchMedia();e.add({isDesktop:"(min-width: 768px) and (prefers-reduced-motion: no-preference)",isMobile:"(max-width: 767px) and (prefers-reduced-motion: no-preference)"},e=>{e=e.conditions.isDesktop;const t=gsap.timeline();e&&t.from(".textLline__first",{x:"200px",scrollTrigger:{trigger:".discountedProducts",start:"top bottom",end:"bottom bottom",scrub:!0}}).from(".textLline__second",{x:"-200px",scrollTrigger:{trigger:".discountedProducts",start:"top bottom",end:"bottom bottom",scrub:!0}},0)})}function initIntroSlider(){const e=document.querySelector(".intro"),t=e.querySelectorAll(".intro__slider"),n=e.querySelector(".intro__prev"),o=e.querySelector(".intro__next"),r=e.querySelector(".intro__pagination");{var d=t[0].children[0].children.length-2;const c=document.createDocumentFragment();for(let t=0;t<d;t++){let e=document.createElement("LI");0===t?e.classList.add("intro__paginationItem","active"):e.classList.add("intro__paginationItem"),e.innerHTML="<span></span>",c.append(e)}r.append(c)}t.forEach(e=>{const t=e.querySelectorAll(".intro__slide")[2];t.classList.add("current-slide"),doAddInitSettingsToIntroSlider(e)});const s={intro:e,intro_sliders:t,prev_btn:n,next_btn:o,pagination:r},u="to_left",i=()=>{handleIntroBtn(u,s)};function l(){const e=gsap.timeline();return e.set(i,{delay:5,onRepeat:i,repeat:-1,repeatDelay:5},0)}let a=l();[n,o].forEach(e=>{let t="";t=e.classList.contains("intro__next")?"to_left":"to_right",e.addEventListener("click",()=>{a.kill(),requestAnimationFrame(()=>{handleIntroBtn(t,s)}),a=l()})})}function handleIntroBtn(t,n){const{intro_sliders:e,pagination:o}=n;e.forEach(e=>{doIntroSliderAnimation(e,n,t)});var r=e[0].querySelector(".current-slide").dataset.slideNumber;Array.from(o.children).forEach(e=>e.classList.remove("active")),o.children[r-1].classList.add("active")}function doReplaceIntroSliderElements(...e){const[t,n]=e,o=t.querySelector(".intro__sliderWrapper");e=Array.from(t.querySelectorAll(".intro__slide"));if("to_left"===n){const s=e[e.length-3];var r=s.cloneNode(!0);const i=e[0];i.remove(),o.append(r)}else{const l=e[e.length-3];r=l.cloneNode(!0);const a=e[e.length-1];a.remove(),o.prepend(r)}}function doAddInitSettingsToIntroSlider(e){const t=Array.from(e.querySelectorAll(".intro__slide"));t.forEach((e,t)=>{t<2?(e.style.left="-100%",e.children[0].style.transform="translate(90%, 0)"):2===t?(e.style.left="0",e.children[0].style.transform="translate(0, 0)"):(e.style.left="100%",e.children[0].style.transform="translate(-90%, 0)")})}function doIntroSliderAnimation(e,t,n){var{prev_btn:t,next_btn:o}=t;const r=e.querySelector(".current-slide");var d=r.children[0];let s=null,i=null,l,a,c;c="to_left"===n?(s=r.nextElementSibling,i=s.children[0],l="-5%",a="-100%","90%"):(s=r.previousElementSibling,i=s.children[0],l="5%",a="100%","-90%"),gsapAnimationIntroSlider({slider:e,direction:n,prev_btn:t,next_btn:o,currentSlide:r,currentSlideInner:d,newSlide:s,newSlideInner:i,firstCurrentSlideOffsset:l,lastCurrentSlideOffset:a,lastCurrentSlideInnerOffset:c}),r.classList.remove("current-slide"),s.classList.add("current-slide")}function gsapAnimationIntroSlider(e){var{slider:e,direction:t,prev_btn:n,next_btn:o,currentSlide:r,currentSlideInner:s,newSlide:i,newSlideInner:l,firstCurrentSlideOffsset:a,lastCurrentSlideOffset:c,lastCurrentSlideInnerOffset:d}=e;const u=gsap.timeline();return u.call(doAddClassToButtons,[n,o],0).set(r,{zIndex:1}).set(i,{zIndex:2}).to(r,{left:a,duration:.4}).to(i,{left:"0%",duration:.4},0).to(l,{x:"0%",duration:.4},0).set(r,{left:c}).set(s,{x:d}).call(doRemoveClassToButtons,[n,o]).call(doReplaceIntroSliderElements,[e,t]).call(doAddInitSettingsToIntroSlider,[e])}function initPromotionsSectionSlider(){doCheckSlidesAmount({counter:0,section:document.querySelector(".promotionsSection"),sectionItemsClassName:".promotionsSection__item",sliders_wrappers:Array.from(document.querySelectorAll(".promotionsSection__sliderWrapper")),prev_btn:document.querySelector(".promotionsSection__nav .intro__prev"),next_btn:document.querySelector(".promotionsSection__nav .intro__next")})}function initAllGoodsSectionsSliders(){var e=Array.from(document.querySelectorAll(".goodsSection")),t=document.querySelector(".discountedProducts");sections=[].concat(e,[t]),sections.forEach(e=>{var t=Array.from(e.querySelectorAll(".goodsCard__sliderWrapper")),n=e.querySelector(".intro__prev"),o=e.querySelector(".intro__next");doCheckSlidesAmount({counter:0,section:e,sectionItemsClassName:".goodsCard__item",sliders_wrappers:t,prev_btn:n,next_btn:o})})}function doCheckSlidesAmount(e){let{counter:t,section:n,sectionItemsClassName:o,sliders_wrappers:r,prev_btn:s,next_btn:i}=e;let l=[];r.forEach(e=>{l.push(e.children.length)});var a=Math.min(...l);if(1<a){const e={counter:t,section:n,sliders_wrappers:r,prev_btn:s,next_btn:i,slidesAmount:a,sectionItemsClassName:o};doInitGeneralSliderLogic(e)}else n.classList.add("slider-start","slider-finish")}function doInitGeneralSliderLogic(e){let{counter:t,section:n,sliders_wrappers:o,prev_btn:r,next_btn:s,slidesAmount:i,sectionItemsClassName:l}=e;768<=window.innerWidth&&(o.forEach(e=>doSetInitSettings(e)),a());const d=window.matchMedia("(max-width: 767px)");function a(){s.addEventListener("click",c),r.addEventListener("click",c)}function c(e){if(e.currentTarget.classList.contains("intro__next"))o.forEach(e=>handleSliderNavButtons(e,t,r,s,"next")),t+=1,doCheckCounter(t,n,i);else if(e.currentTarget.classList.contains("intro__prev"))o.forEach(e=>handleSliderNavButtons(e,t,r,s,"prev")),--t,doCheckCounter(t,n,i)}d.addEventListener("change",e=>{e.matches?(t=0,n.classList.add("slider-start"),n.classList.remove("slider-finish"),o.forEach(e=>doSetInitSettings(e)),s.removeEventListener("click",c),r.removeEventListener("click",c)):(doRemoveAllAddedElements(Array.from(n.querySelectorAll(l)),4),a())})}function doRemoveAllAddedElements(e,n){e.forEach((e,t)=>{n<=t&&e.remove()})}function doSetInitSettings(e){const t=Array.from(e.children);t.forEach((e,t)=>{0===t?(e.style.left="0%",Array.from(e.children).forEach(e=>e.style.transform="translate(0, 0)")):(e.style.left="100%",Array.from(e.children).forEach(e=>e.style.transform="translate(-90%, 0)"))})}function doCheckCounter(e,t,n){0===e?(t.classList.add("slider-start"),t.classList.remove("slider-finish")):0<e&&2===n?(t.classList.add("slider-finish"),t.classList.remove("slider-start")):0<e&&e<n-1?t.classList.remove("slider-start","slider-finish"):(t.classList.remove("slider-start"),t.classList.add("slider-finish"))}function doAddClassToButtons(...e){e.forEach(e=>e.classList.add("disabled"))}function doRemoveClassToButtons(...e){e.forEach(e=>e.classList.remove("disabled"))}function handleSliderNavButtons(e,t,n,d,o){var e=e.children,r=e[t],s=r.children,u=s[1];let i=null,l,a,c;c="next"===o?(i=e[t+1],l="-5%",a="-100%","90%"):(i=e[t-1],l="5%",a="100%","-90%");o=i.children;u?gsapAnimationForPromotionsSlider({prev_btn:n,next_btn:d,currentSlideName:u,currentSlide:r,currentSlideInner:s,newSlide:i,newSlideInner:o,firstCurrentSlideOffsset:l,lastCurrentSlideOffset:a,lastCurrentSlideInnerOffset:c}):gsapAnimationForGoodsSectionSlider({prev_btn:n,next_btn:d,currentSlide:r,currentSlideInner:s,newSlide:i,newSlideInner:o,firstCurrentSlideOffsset:l,lastCurrentSlideOffset:a,lastCurrentSlideInnerOffset:c})}function gsapAnimationForPromotionsSlider(e){var{prev_btn:e,next_btn:t,currentSlideName:n,currentSlide:o,currentSlideInner:r,newSlide:s,newSlideInner:i,firstCurrentSlideOffsset:l,lastCurrentSlideOffset:a,lastCurrentSlideInnerOffset:c}=e;const d=gsap.timeline();return d.call(doAddClassToButtons,[e,t],0).set(n,{opacity:0}).set(o,{zIndex:1}).set(s,{zIndex:2}).to(o,{left:l,duration:.4}).to(s,{left:"0%",duration:.4},0).to(i,{x:"0%",duration:.4},0).set(o,{left:a}).set(n,{opacity:1}).set(r,{x:c}).call(doRemoveClassToButtons,[e,t])}function gsapAnimationForGoodsSectionSlider(e){var{prev_btn:e,next_btn:t,currentSlide:n,currentSlideInner:o,newSlide:r,newSlideInner:s,firstCurrentSlideOffsset:i,lastCurrentSlideOffset:l,lastCurrentSlideInnerOffset:a}=e;const c=gsap.timeline();return c.call(doAddClassToButtons,[e,t],0).set(n,{zIndex:1}).set(r,{zIndex:2}).to(n,{left:i,duration:.4}).to(r,{left:"0%",duration:.4},0).to(s,{x:"0%",duration:.4},0).set(n,{left:l}).set(o,{x:a}).call(doRemoveClassToButtons,[e,t])}document.addEventListener("DOMContentLoaded",function(e){doHeaderInit(),doPanelInit(),doToggleFooterAccordion(),gsap.registerPlugin(ScrollTrigger);document.querySelector(".intro")&&(initIntroSlider(),initAutoscrollBlocks(),doRemoveMapOverlayByClick(),doInitMapStoresSelect(),doAddMapStoresListener(),doHideMapDescription(),doToggleFavoritesIcons(),initParallaxPromotionsSection(),initAnimateTextPromotionsSection(),initPromotionsSectionSlider(),initAllGoodsSectionsSliders(),"undefined"!=typeof ymaps&&null!==ymaps&&setTimeout(doInitMap,0));var t=document.querySelector(".catalog-page"),t=(t&&(doToggleFavoritesIcons(),doSortMenuLogic(),doFiltersMenuLogic(),handleAllInputRange()),document.querySelector(".catalog-brand-page")),t=(t&&(doToggleFavoritesIcons(),doSortMenuLogic(),doFiltersMenuLogic(),handleAllInputRange(),doToggleBrandDescription()),document.querySelector(".catalog-favorites-page")),t=(t&&doToggleFavoritesIcons(),document.querySelector(".catalog-search-result-page"));t&&doToggleFavoritesIcons()});