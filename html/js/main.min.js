...
function debounce(o,r){return function(...e){var t=this.lastCall;this.lastCall=Date.now(),t&&this.lastCall-t<=r&&clearTimeout(this.lastCallTimer),this.lastCallTimer=setTimeout(()=>o(...e),r)}}function doStartFirstScreenAnimation(){const e=gsap.timeline();e.set(".header",{opacity:1},0).set(".intro",{opacity:1},0).from(".header__container",{delay:.5,opacity:0,y:"-10px",duration:.4}).from(".header__container .container",{opacity:0,y:5,duration:.8}).from(".panel__line",{width:0,duration:.5},"-=0.4").from(".panel__title",{opacity:0,y:-5,duration:.4},"-=0.4").from(".panel__nav",{opacity:0,x:-30,duration:.7},"-=0.1").from(".panel__menu",{opacity:0,x:30,duration:.7},"<").from(".intro__block--center",{opacity:0,y:50,scale:.9,duration:.7},"<").from(".intro__block--left",{opacity:0,x:-50,duration:.4},"-=0.2").from(".intro__block--right",{opacity:0,x:50,duration:.4},"<").from(".intro__nav",{opacity:0,duration:.4,onComplete:()=>initIntroSlider()},3).from(".intro__pagination",{opacity:0,y:10,duration:.4})}function doHeaderInit(){const t=document.querySelector(".header__container"),o=document.querySelector(".header__menu"),e=document.querySelector(".header__btn"),r=document.querySelector(".header__overlay");function n(){t.classList.contains("active")?(t.classList.remove("active"),o.style.maxHeight=0,r.classList.remove("show")):(t.classList.add("active"),o.style.maxHeight=o.scrollHeight+"px",o.style.opacity=1,r.classList.add("show"))}e.addEventListener("click",()=>{requestAnimationFrame(n)}),r.addEventListener("click",()=>{t.classList.remove("active"),o.style.maxHeight=0,r.classList.remove("show")});const s=window.matchMedia("(max-width: 1300px)");s.addEventListener("change",function(e){e.matches?(o.style.maxHeight=0,o.style.opacity=0):(t.classList.remove("active"),o.style.maxHeight=o.scrollHeight+"px",o.style.opacity=1)})}function doPanelInit(){const e=document.querySelectorAll(".panel__input"),t=document.querySelectorAll(".panel__clear");function o(e){const t=e.nextElementSibling;e.value="",e.classList.remove("active"),t.classList.remove("visible")}e.forEach(e=>e.addEventListener("input",n=>requestAnimationFrame(()=>{{var e=n;const t=Boolean(e.target.value),o=e.target,r=o.nextElementSibling;return void(t?(o.classList.add("active"),r.classList.add("visible")):(o.classList.remove("active"),r.classList.remove("visible")))}}))),t.forEach(e=>e.addEventListener("click",r=>requestAnimationFrame(()=>{{var e;const t=r.target.closest(".panel__clear"),o=t.previousElementSibling;return o.value="",o.classList.remove("active"),o.focus(),void t.classList.remove("visible")}})));const r=document.body,n=document.getElementById("show-menu"),s=document.getElementById("menu-overlay"),a=document.getElementById("menu"),i=document.querySelector(".panel__showCategories");n.addEventListener("click",()=>{requestAnimationFrame(()=>{[s,a,i].forEach(e=>e.classList.toggle("active")),r.classList.toggle("lock"),e.forEach(e=>o(e))})}),s.addEventListener("click",()=>{requestAnimationFrame(()=>{[s,a,i].forEach(e=>e.classList.remove("active")),r.classList.remove("lock"),e.forEach(e=>o(e))})})}function doCreateMapScript(t){setTimeout(function(){var e=document.createElement("script");e.async=!1,e.src="https://api-maps.yandex.ru/2.1/?apikey=key&lang=ru_RU",document.body.appendChild(e),e.onload=()=>t()},2e3)}document.addEventListener("DOMContentLoaded",function(e){doHeaderInit(),doPanelInit(),doToggleFooterAccordion(),doShowAuth(),doShowRegistration(),doHideAuth(),doInitMaskInput(),checkAuthForm(),gsap.registerPlugin(ScrollTrigger);document.querySelector(".index")&&(doStartFirstScreenAnimation(),doAnimationByScrollMainPage(),doFooterAnimationByScroll(),doInitMapStoresSelect(),doHideMapDescription(),doToggleFavoritesIcons(),initParallaxPromotionsSection(),initAnimateTextPromotionsSection(),initPromotionsSectionSlider(),initAllGoodsSectionsSliders(),doCreateMapScript(doInitMap));var t=document.querySelector(".catalog-page"),t=(t&&(doToggleFavoritesIcons(),doSortMenuLogic(),doFiltersMenuLogic(),handleAllInputRange(),catalogSearchBrannd()),document.querySelector(".catalog-brand-page")),t=(t&&(doToggleFavoritesIcons(),doSortMenuLogic(),doFiltersMenuLogic(),handleAllInputRange(),doToggleBrandDescription()),document.querySelector(".catalog-favorites-page")),t=(t&&doToggleFavoritesIcons(),document.querySelector(".catalog-search-result-page")),t=(t&&doToggleFavoritesIcons(),document.querySelector(".catalog-item")),t=(t&&(doInitCatalogItemSlider(),doSelectValueButton(),doToggleDetailsValuesAppearance(),doCheckSetValueAmount(),doChangeToggleBtnAmountByResize(),doToggleAddToFavoritesBtn(".details__add-to-favorites",".item"),doToggleInfoTabs(),doChangeGoodsAmount(".goods-amount",!1),doToggleReviewsPanel(),checkNewCommentForm(),doShowOneclick(),doHideOneclick(),checkOneclickForm(),doSetCursorToEnd(),initAllGoodsSectionsSliders(),doToggleFavoritesIcons(),doResetEmptyInputByBlur(),doToggleAddToCartButton(),addListernerToRemoveBtn(),doInitFileRead(),doShowFullscreen(),handleCloseFormSubmitedMessage()),document.querySelector(".cart-page")),t=(t&&(doToggleAddToFavoritesBtn(".cart__add-to-favorites",".cart__regular-row"),doChangeGoodsAmount(".goods-amount",!0),doAddListenersToAllAmountInput(),doRemoveGoodFromCart(),doClearCart(),doResetEmptyInputByBlur()),document.querySelector(".brands-page")),t=(t&&(doInitBrandsSearch(),doInitSmoothScroll(),doBrandsSearch()),document.querySelector(".order-placement-page")),t=(t&&(doInitMapStoresSelect(),doChooseStore(),doHideMapDescription(),doSwitchOrderStep(),doCreateMapScript(doInitMap)),document.querySelector(".cabinet-favorites-page")),t=(t&&doToggleFavoritesIcons(),document.querySelector(".cabinet-user-orders-page")),t=(t&&doToggleCabinetNav(),document.querySelector(".cabinet-personal-data-page")),t=(t&&(doInitMaskInput(),checkRequiredFormInputs(),doChangeInputState(),doClearInput()),document.querySelector(".cabinet-orders-item-page")),t=(t&&doToggleCabinetAccordion(),document.querySelector(".news-item-page")),t=(t&&(doInitContentSlider(),initAllGoodsSectionsSliders()),document.querySelector(".promotions-item-page")),t=(t&&(initAllGoodsSectionsSliders(),doToggleFavoritesIcons()),document.querySelector(".company-page")),t=(t&&(doInitCompanySlider(),doInitMaskInput(),checkRequiredFormInputs(),doShowCertificatesFullscreen()),document.querySelector(".stores-page")),t=(t&&(doInitMapStoresSelect(),doHideMapDescription(),doCreateMapScript(doInitMap)),document.querySelector(".contacts-page"));t&&doCreateMapScript(doInitContatcsMap)});var marks={},mark_link="images/map-mark.svg",mark_current_link="images/map-current-mark.svg";const stores=[{id:"60",title:"Магазин на Измайловском шоссе",coords:["55.778421","37.727841"],address:"г. Москва, Измайловское шоссе 28",time:"",phone:"+7 963 775 53 70",email:"info@rrbeauty.kz",city:"Москва"},{id:"31",title:"Магазин на проспекте Абая",coords:["43.239961","76.926565"],address:"г. Алматы, Олимпик, ​проспект Абая, 44/1​1 этаж; 16 офис",time:"",phone:"+77017312525",email:"info@rrbeauty.kz",city:"Алматы"},{id:"61",title:"Магазин на проспекте Кунаева",coords:["42.345036","69.609185"],address:"г. Шымкент, проспект Кунаева 91, ЖК БИИК",time:"",phone:"+7 701 599 9981",email:"info@rrbeauty.kz",city:"Шымкент"},{id:"63",title:"Магазин на ул. Александра Бараева",coords:["51.158563","71.439215"],address:"г. Астана, ул. Александра Бараева 16, БЦ Лига, Блок А, этаж 2, офис 208а",time:"",phone:"+7 701 731 25 25",email:"info@rrbeauty.kz",city:"Астана"},{id:"32",title:"Магазин на ул. Кабдолова",coords:["43.237767","76.858571"],address:"г. Алматы, Кабдолова 2",time:"",phone:"+7 775 352 52 39",email:"info@rrbeauty.kz",city:"Алматы"},{id:"62",title:"Магазин ул. Гурьевская",coords:["47.103033","51.926513"],address:"г. Атырау, ТД Ажар, ул. Гурьевская 4А",time:"",phone:"+7 771 408 8650",email:"info@rrbeauty.kz",city:"Атырау"}];function getAllCoords(){if(0<stores.length)return stores.map(e=>e.coords.map(e=>Number(e)))}function getCurrentStoresCoords(){let t=document.querySelector(".map__stores option").textContent,e=stores.filter(e=>e.city===t);if(0<e.length)return e.map(e=>e.coords.map(e=>Number(e)))}function doInitMap(){ymaps.ready(function(){let e=getAllCoords();var o=getCurrentStoresCoords();if(ymaps){let t=new ymaps.Map("map-section-wrapper",{bounds:ymaps.util.bounds.fromPoints(o)});t.setZoom(t.getZoom()-.4);const r=document.querySelector(".map__description"),n=((marks=e.map(e=>new ymaps.Placemark(e,{},{iconLayout:"default#image",iconImageHref:mark_link,iconImageSize:[32,32],iconImageOffset:[-15,-5]}))).forEach(e=>t.geoObjects.add(e)),marks.forEach(e=>e.events.add("click",e=>{if(changeMapMarks(e,marks),"images/map-current-mark.svg"===e.get("target").options.get("iconImageHref")){r.classList.add("show");const t=gsap.timeline();t.from([".map__storeName",".map__data",".map__choose",".map__close"],{autoAlpha:0,x:20,ease:Power4.easeOut,duration:.5,stagger:{each:.08}})}else r.classList.remove("show")})),configureMap(t),document.querySelector(".map__stores"));n.addEventListener("change",()=>{var e=getCurrentStoresCoords(),e=(t.setBounds(ymaps.util.bounds.fromPoints(e)),t.getZoom());17<e?t.setZoom(17):t.setZoom(t.getZoom()-.4)})}})}function doInitContatcsMap(){const n=[{coord:[51.158562572612595,71.43921449999996],content:"Краснодар, В. Головатого, 313"},{coord:[51.159952,71.441514],content:"Краснодар, В. Головатого, 310"},{coord:[51.157783,71.442053],content:"Краснодар, В. Головатого, 200"}];ymaps.ready(function(){var t,o,r,e=n[0].coord;ymaps&&(t=new ymaps.Map("map-section-wrapper",{center:e,zoom:13}),o=ymaps.templateLayoutFactory.createClass('<div class="balloon-root "><a class="close" href="#">&times;</a><div class="arrow balloon-pin"></div><div class="balloon-body balloon">$[properties.balloonContent]</div></div>',{build:function(){this.constructor.superclass.build.call(this),this._$element=$(".balloon-root",this.getParentElement()),this.applyElementOffset(),this._$element.find(".close").on("click",$.proxy(this.onCloseClick,this))},clear:function(){this._$element.find(".close").off("click"),this.constructor.superclass.clear.call(this)},onCloseClick:function(e){e.preventDefault(),this.events.fire("userclose")},applyElementOffset:function(){this._$element.css({left:-(this._$element[0].offsetWidth/2-5),top:-this._$element[0].offsetHeight-36})}}),(r=n.map(e=>new ymaps.Placemark(e.coord,{balloonContent:e.content},{iconLayout:"default#image",iconImageHref:mark_link,iconImageSize:[32,32],iconImageOffset:[-15,-5],zIndexActive:11,balloonShadow:!1,balloonLayout:o,balloonPanelMaxMapArea:1,hideIconOnBalloonOpen:!1}))).forEach(e=>t.geoObjects.add(e)),r.forEach(e=>e.events.add("click",e=>{changeMapMarks(e,r)})),configureMap(t))})}function changeMapMarks(e,t){"images/map-current-mark.svg"===e.get("target").options.get("iconImageHref")?(e.get("target").options.set("iconImageHref",mark_link),e.get("target").options.set("iconImageSize",[32,32])):(t.forEach(e=>e.options.set("iconImageHref",mark_link)),t.forEach(e=>e.options.set("iconImageSize",[32,32])),e.get("target").options.set("iconImageHref",mark_current_link),e.get("target").options.set("iconImageSize",[40,40]))}function configureMap(t){t.controls.remove("geolocationControl"),t.controls.remove("searchControl"),t.controls.remove("trafficControl"),t.controls.remove("typeSelector"),t.controls.remove("fullscreenControl"),t.controls.remove("rulerControl"),t.behaviors.disable(["scrollZoom"]),window.innerWidth<=767&&t.behaviors.disable("drag");const e=window.matchMedia("(max-width: 767px)");e.addEventListener("change",e=>{e.matches?t.behaviors.disable("drag"):t.behaviors.enable("drag")})}function doInitMapStoresSelect(){var e=document.querySelector(".map__stores");new Choices(e,{silent:!1,searchEnabled:!1,itemSelectText:""})}function doChooseStore(){var e=document.querySelector(".map__description");document.querySelector(".map__choose").addEventListener("click",()=>e.classList.toggle("checked"))}function doHideMapDescription(){const e=document.querySelector(".map__description"),t=document.querySelector(".map__close");t.addEventListener("click",()=>{e.classList.remove("show"),marks.forEach(e=>{e.options.set("iconImageHref",mark_link),e.options.set("iconImageSize",[32,32])})})}function doToggleFooterAccordion(){window.innerWidth<=575&&doAddListenersToFooterAccordions();const e=window.matchMedia("(max-width: 575px)");e.addEventListener("change",e=>{(e.matches?doAddListenersToFooterAccordions:doRemoveListenersToFooterAccordions)()})}function handleFooterAccordions(e){const t=e.target.closest(".footer__column"),o=t.children[1];t.classList.toggle("active");e=t.classList.contains("active");o.style.maxHeight=e?o.scrollHeight+"px":null}function doAddListenersToFooterAccordions(){const e=document.querySelectorAll(".footer__column");e.forEach(e=>{const t=e.children[0];t.addEventListener("click",handleFooterAccordions)})}function doRemoveListenersToFooterAccordions(){const e=document.querySelectorAll(".footer__column");e.forEach(e=>{const t=e.children[0],o=e.children[1];t.removeEventListener("click",handleFooterAccordions),e.classList.remove("active"),o.style.maxHeight=null})}function doToggleFavoritesIcons(){const e=document.querySelectorAll(".goodsCard__addToFavorites");e.forEach(e=>e.addEventListener("click",e=>{const t=e.target.closest(".goodsCard__descr");t.classList.toggle("addedToFavorites")}))}function doSortMenuLogic(){const e=document.body,r=document.querySelector(".options__sortToggleBtn");var t=document.querySelector(".options__overlay");const o=Array.from(document.querySelectorAll(".options__sortList li button")),n=[].concat(t,...o),s=document.querySelector(".options__current");function a(){e.classList.remove("sort-list-open"),n.forEach(e=>e.removeEventListener("click",a))}function i(e){var t=r.dataset.sortType,e=e.target.closest(".options__sortList button"),o=e.dataset.sortType;t!==o&&(s.textContent=e.children[0].textContent,r.dataset.sortType=o,r.querySelector("input").value=o)}r.addEventListener("click",()=>{e.classList.add("sort-list-open"),n.forEach(e=>e.addEventListener("click",a)),o.forEach(e=>e.addEventListener("click",i))})}function doFiltersMenuLogic(){const e=document.querySelector(".options__nav"),t=document.querySelector(".options__filtersToggleBtn"),o=Array.from(document.querySelectorAll(".filters__button")),r=document.querySelector(".filters");t.addEventListener("click",()=>{e.classList.toggle("filters-opened"),r.classList.toggle("filters-opened")}),o.forEach(o=>o.addEventListener("click",()=>{const e=o.closest(".filters__block"),t=e.querySelector(".filters__wrapper");e.classList.toggle("filters-block-opened"),e.classList.contains("filters-block-opened")?t.style.maxHeight=t.scrollHeight+"px":t.style.maxHeight=null}))}function handleAllInputRange(){const e=document.querySelectorAll(".filters__range");function t(e){let t,o;var r=e.target.classList.contains("filters__inputMin"),n=e.target.classList.contains("filters__inputMax");r?(t=e.target,o=t.nextElementSibling):n&&(o=e.target,t=o.previousElementSibling);const s=t.closest(".filters__wrapper"),a=s.querySelector(".filters__track"),i=s.querySelector(".filters__valueMin"),c=s.querySelector(".filters__valueMax");var n=parseInt(t.value),e=parseInt(o.value);let l;l=parseInt(o.max)-parseInt(t.min)<=10?1:parseInt(o.max)-parseInt(t.min)<=100?10:50,e-n<l?r?t.value=e-l:o.value=n+l:(i.value=""+n,c.value=""+e,r=100*(n-t.min)/(t.max-t.min)+"%",n=100*(o.max-e)/(o.max-o.min)+"%",a.style.left=r,a.style.right=n)}e.forEach(e=>e.addEventListener("input",t));const o=Array.from(document.querySelectorAll(".filters__valueMin")),r=Array.from(document.querySelectorAll(".filters__valueMax"));function n(e){const t=e.target,o=t.closest(".filters__wrapper"),r=o.querySelector(".filters__inputMin"),n=o.querySelector(".filters__inputMax");var e=t.classList.contains("filters__valueMin"),s=t.classList.contains("filters__valueMax");const a=o.querySelector(".filters__track");let i,c=(i=n.max-r.min<=10?1:n.max-r.min<=100?10:50,parseInt(t.value));function l(){var e=100*(c-r.min)/(r.max-r.min)+"%";a.style.left=e}function d(){var e=100*(n.max-c)/(n.max-n.min)+"%";a.style.right=e}e&&(c<t.min||Number.isNaN(c)?(t.value="",r.value=parseInt(t.min),a.style.left=0):(c>n.value-i?(t.value=parseInt(n.value)-i,r.value=parseInt(n.value)-i):(t.value=c,r.value=c),l())),s&&(c>parseInt(t.max)||Number.isNaN(c)?(t.value="",n.value=parseInt(t.max),a.style.right="0"):(c<parseInt(r.value)+i?(t.value=parseInt(r.value)+i,n.value=parseInt(r.value)+i):(t.value=c,n.value=c),d()))}o.forEach(e=>e.addEventListener("change",n)),r.forEach(e=>e.addEventListener("change",n)),o.forEach(e=>e.addEventListener("blur",n)),r.forEach(e=>e.addEventListener("blur",n))}function doToggleBrandDescription(){const e=document.querySelector(".brandDescription"),t=document.querySelector(".brandDescription__title"),o=document.querySelector(".brandDescription__info");t.addEventListener("click",()=>{e.classList.toggle("brand-description-opened"),e.classList.contains("brand-description-opened")?o.style.maxHeight=o.scrollHeight+"px":o.style.maxHeight=null})}function initParallaxPromotionsSection(){const e=document.querySelector(".discountedProducts"),o=e.querySelectorAll(".goodsCard__item");let t=gsap.matchMedia();t.add({isDesktop:"(min-width: 992px) and (prefers-reduced-motion: no-preference)",isMobile:"(max-width: 991px) and (prefers-reduced-motion: no-preference)"},e=>{e=e.conditions.isDesktop;const t=gsap.timeline();return e&&t.from(o[0],{y:"-232px",ease:Power1.easeOut,scrollTrigger:{trigger:".goodsCard__wrapper",start:"top 90%",end:"bottom 90%",scrub:!0}}).from(o[2],{y:"-98px",ease:Power4.easeOut,scrollTrigger:{trigger:".goodsCard__wrapper",start:"+=200px bottom",end:"bottom+=200px bottom",scrub:!0}},"-=2"),()=>{}})}function doAnimationByScrollMainPage(){var e=Array.from(document.querySelectorAll(".animated__title")),t=Array.from(document.querySelectorAll(".popularCategories__img")),o=Array.from(document.querySelectorAll(".popularCategories__name")),r=Array.from(document.querySelectorAll(".brandsSection__item")),n=Array.from(document.querySelectorAll(".over")),s=Array.from(document.querySelectorAll(".promotionsSection__block--first")),a=Array.from(document.querySelectorAll(".promotionsSection__block--second")),i=Array.from(document.querySelectorAll(".promotionsSection__block--first .promotionsSection__item:first-child")),c=Array.from(document.querySelectorAll(".promotionsSection__block--second .promotionsSection__item")),l=Array.from(document.querySelectorAll(".goodsSection .goodsCard__slide")),d=Array.from(document.querySelectorAll(".footer__main-wrapper"));const u=[].concat(e,t,o,r,n,s,a,i,c,l,d);u.forEach((e,t)=>{ScrollTrigger.create({trigger:e,start:"top 90%",once:!0,toggleClass:"animate"})})}function doFooterAnimationByScroll(){var e=Array.from(document.querySelectorAll(".footer__copyright"));const t=[].concat(e);t.forEach((e,t)=>{ScrollTrigger.create({trigger:e,start:"top bottom",once:!0,toggleClass:"animate"})})}function initAnimateTextPromotionsSection(){let e=gsap.matchMedia();e.add({isDesktop:"(min-width: 768px) and (prefers-reduced-motion: no-preference)",isMobile:"(max-width: 767px) and (prefers-reduced-motion: no-preference)"},e=>{e=e.conditions.isDesktop;const t=gsap.timeline();e&&t.from(".textLline__first",{x:"200px",scrollTrigger:{trigger:".discountedProducts",start:"top bottom",end:"bottom bottom",scrub:!0}}).from(".textLline__second",{x:"-200px",scrollTrigger:{trigger:".discountedProducts",start:"top bottom",end:"bottom bottom",scrub:!0}},0)})}function initIntroSlider(){const e=document.querySelector(".intro"),t=e.querySelectorAll(".intro__slider"),o=e.querySelector(".intro__prev"),r=e.querySelector(".intro__next"),n=(t.forEach(e=>{const t=e.querySelectorAll(".intro__slide")[2];t.classList.add("current-slide"),doAddInitSettingsToIntroSlider(e)}),{intro:e,intro_sliders:t,prev_btn:o,next_btn:r});let s=function(){const e=gsap.timeline();return e.to(".intro__paginationItem.active span",{x:"0%",duration:5},0).to(".intro__paginationItem span",{x:"-100%",duration:0,onComplete:()=>handleIntroBtn("to_left",n)})}();s.repeat(-1),[o,r].forEach(e=>{let t="";t=e.classList.contains("intro__next")?"to_left":"to_right",e.addEventListener("click",()=>{requestAnimationFrame(()=>{handleIntroBtn(t,n)}),s.restart()})})}function handleIntroBtn(t,o){const e=o["intro_sliders"];e.forEach(e=>{doIntroSliderAnimation(e,o,t)})}function doReplaceIntroSliderElements(...e){const[t,o]=e,r=t.querySelector(".intro__sliderWrapper");e=Array.from(t.querySelectorAll(".intro__slide"));if("to_left"===o){const n=e[2],s=n.cloneNode(!0),a=(s.classList.remove("current-slide"),e[0]);a.remove(),r.append(s)}else{const i=e[3],c=i.cloneNode(!0),l=(c.classList.remove("current-slide"),e[e.length-1]);l.remove(),r.prepend(c)}}function doAddInitSettingsToIntroSlider(e){const t=Array.from(e.querySelectorAll(".intro__slide"));t.forEach((e,t)=>{t<2?(e.style.left="-100%",e.children[0].style.transform="translate(90%, 0)"):2===t?(e.style.left="0",e.children[0].style.transform="translate(0, 0)"):(e.style.left="100%",e.children[0].style.transform="translate(-90%, 0)")})}function doIntroSliderAnimation(e,t,o){var{prev_btn:t,next_btn:r}=t,n=e.querySelector(".current-slide");const d=e.querySelectorAll(".intro__slide");var u=n.children[0];let s=null,a=null,i,c,l;l="to_left"===o?(s=n.nextElementSibling,a=s.children[0],i="-5%",c="-100%","90%"):(s=n.previousElementSibling,a=s.children[0],i="5%",c="100%","-90%"),gsapAnimationIntroSlider({slider:e,direction:o,prev_btn:t,next_btn:r,currentSlide:n,currentSlideInner:u,newSlide:s,newSlideInner:a,firstCurrentSlideOffsset:i,lastCurrentSlideOffset:c,lastCurrentSlideInnerOffset:l}),d.forEach(e=>e.classList.remove("current-slide")),s.classList.add("current-slide")}function gsapAnimationIntroSlider(e){var{slider:e,direction:t,prev_btn:o,next_btn:r,currentSlide:n,currentSlideInner:s,newSlide:a,newSlideInner:i,firstCurrentSlideOffsset:c,lastCurrentSlideOffset:l,lastCurrentSlideInnerOffset:d}=e;const u=gsap.timeline();return u.call(doAddClassToButtons,[o,r],0).set(n,{zIndex:1}).set(a,{zIndex:2}).to(n,{left:c,duration:.4}).to(a,{left:"0%",duration:.4},0).to(i,{x:"0%",duration:.4},0).set(n,{left:l}).set(s,{x:d}).call(doRemoveClassToButtons,[o,r]).call(doReplaceIntroSliderElements,[e,t]).call(doAddInitSettingsToIntroSlider,[e])}function initPromotionsSectionSlider(){doCheckSlidesAmount({counter:0,section:document.querySelector(".promotionsSection"),sectionItemsClassName:".promotionsSection__item",sliders_wrappers:Array.from(document.querySelectorAll(".promotionsSection__sliderWrapper")),prev_btn:document.querySelector(".promotionsSection__nav .intro__prev"),next_btn:document.querySelector(".promotionsSection__nav .intro__next")})}function initAllGoodsSectionsSliders(){var e=Array.from(document.querySelectorAll(".goodsSection")),t=document.querySelector(".discountedProducts"),o=document.querySelector(".news-item-page"),n=4,n=o?3:4;sections=t?[].concat(e,[t]):e,sections.forEach(e=>{var t=Array.from(e.querySelectorAll(".goodsCard__sliderWrapper")),o=e.querySelector(".intro__prev"),r=e.querySelector(".intro__next");doCheckSlidesAmount({counter:0,section:e,sectionItemsClassName:".goodsCard__item",sliders_wrappers:t,prev_btn:o,next_btn:r,slidesToLeave:n})})}function doCheckSlidesAmount(e){let{counter:t,section:o,sectionItemsClassName:r,sliders_wrappers:n,prev_btn:s,next_btn:a,slidesToLeave:i}=e;let c=[];n.forEach(e=>{c.push(e.children.length)});var l=Math.min(...c);if(1<l){const e={counter:t,section:o,sliders_wrappers:n,prev_btn:s,next_btn:a,slidesAmount:l,sectionItemsClassName:r,slidesToLeave:i};doInitGeneralSliderLogic(e)}else o.classList.add("slider-start","slider-finish")}function doInitGeneralSliderLogic(e){let{counter:t,section:o,sliders_wrappers:r,prev_btn:n,next_btn:s,slidesAmount:a,sectionItemsClassName:i,slidesToLeave:d}=e;768<=window.innerWidth&&(r.forEach(e=>doSetInitSettings(e)),c());const u=window.matchMedia("(max-width: 767px)");function c(){s.addEventListener("click",l),n.addEventListener("click",l)}function l(e){if(e.currentTarget.classList.contains("intro__next"))r.forEach(e=>handleSliderNavButtons(e,t,n,s,"next")),t+=1,doCheckCounter(t,o,a);else if(e.currentTarget.classList.contains("intro__prev"))r.forEach(e=>handleSliderNavButtons(e,t,n,s,"prev")),--t,doCheckCounter(t,o,a)}u.addEventListener("change",e=>{e.matches?(t=0,o.classList.add("slider-start"),o.classList.remove("slider-finish"),r.forEach(e=>doSetInitSettings(e)),s.removeEventListener("click",l),n.removeEventListener("click",l)):(doRemoveAllAddedElements(Array.from(o.querySelectorAll(i)),d),c())})}function doRemoveAllAddedElements(e,o){e.forEach((e,t)=>{o<=t&&e.remove()})}function doSetInitSettings(e){const t=Array.from(e.children);t.forEach((e,t)=>{0===t?(e.style.left="0%",Array.from(e.children).forEach(e=>e.style.transform="translate(0, 0)")):(e.style.left="100%",Array.from(e.children).forEach(e=>e.style.transform="translate(-90%, 0)"))})}function doCheckCounter(e,t,o){0===e?(t.classList.add("slider-start"),t.classList.remove("slider-finish")):0<e&&2===o?(t.classList.add("slider-finish"),t.classList.remove("slider-start")):0<e&&e<o-1?t.classList.remove("slider-start","slider-finish"):(t.classList.remove("slider-start"),t.classList.add("slider-finish"))}function doAddClassToButtons(...e){e.forEach(e=>e.setAttribute("disabled",!0))}function doRemoveClassToButtons(...e){e.forEach(e=>e.removeAttribute("disabled"))}function handleSliderNavButtons(e,t,o,d,r){var e=e.children,n=e[t],s=n.children,u=s[1];let a=null,i,c,l;l="next"===r?(a=e[t+1],i="-5%",c="-100%","90%"):(a=e[t-1],i="5%",c="100%","-90%");r=a.children,e=document.querySelector(".news-item-page");u?gsapAnimationForPromotionsSlider({prev_btn:o,next_btn:d,currentSlideName:u,currentSlide:n,currentSlideInner:s,newSlide:a,newSlideInner:r,firstCurrentSlideOffsset:i,lastCurrentSlideOffset:c,lastCurrentSlideInnerOffset:l}):e?gsapAnimationForNewsItemPage({prev_btn:o,next_btn:d,currentSlideName:u,currentSlide:n,currentSlideInner:s,newSlide:a,newSlideInner:r,firstCurrentSlideOffsset:i,lastCurrentSlideOffset:c,lastCurrentSlideInnerOffset:l}):gsapAnimationForGoodsSectionSlider({prev_btn:o,next_btn:d,currentSlide:n,currentSlideInner:s,newSlide:a,newSlideInner:r,firstCurrentSlideOffsset:i,lastCurrentSlideOffset:c,lastCurrentSlideInnerOffset:l})}function gsapAnimationForPromotionsSlider(e){var{prev_btn:e,next_btn:t,currentSlideName:o,currentSlide:r,currentSlideInner:n,newSlide:s,newSlideInner:a,firstCurrentSlideOffsset:i,lastCurrentSlideOffset:c,lastCurrentSlideInnerOffset:l}=e;const d=gsap.timeline();return d.call(doAddClassToButtons,[e,t],0).set(o,{opacity:0}).set(r,{zIndex:1}).set(s,{zIndex:2}).to(r,{left:i,duration:.4}).to(s,{left:"0%",duration:.4},0).to(a,{x:"0%",duration:.4},0).set(r,{left:c}).set(o,{opacity:1}).set(n,{x:l}).call(doRemoveClassToButtons,[e,t])}function gsapAnimationForGoodsSectionSlider(e){const{prev_btn:t,next_btn:o,currentSlide:r,currentSlideInner:n,newSlide:s,newSlideInner:a,firstCurrentSlideOffsset:i,lastCurrentSlideOffset:c,lastCurrentSlideInnerOffset:l}=e;e=[r.querySelector(".goodsCard__price"),r.querySelector(".goodsCard__name"),r.querySelector(".goodsCard__about"),r.querySelector(".goodsCard__addToCart")];const d=gsap.timeline();return d.call(doAddClassToButtons,[t,o],0).call(()=>document.querySelectorAll(".goodsSection").forEach(e=>e.classList.add("nodelay"))).set(r,{zIndex:1}).set(s,{zIndex:2}).set(e,{opacity:0}).to(r,{left:i,duration:.4}).to(s,{left:"0%",duration:.4},0).to(a,{x:"0%",duration:.4},0).set(r,{left:c}).set(e,{opacity:1}).set(n,{x:l}).call(()=>document.querySelectorAll(".goodsSection").forEach(e=>e.classList.remove("nodelay"))).call(doRemoveClassToButtons,[t,o])}function gsapAnimationForNewsItemPage(e){const{prev_btn:t,next_btn:o,currentSlide:r,currentSlideInner:n,newSlide:s,newSlideInner:a,firstCurrentSlideOffsset:i,lastCurrentSlideOffset:c,lastCurrentSlideInnerOffset:l}=e;e=[r.querySelector(".news__title"),r.querySelector(".news__subtitle"),r.querySelector(".news__bottom")];const d=gsap.timeline();return d.call(doAddClassToButtons,[t,o],0).call(()=>document.querySelectorAll(".goodsSection").forEach(e=>e.classList.add("nodelay"))).set(r,{zIndex:1}).set(s,{zIndex:2}).set(e,{opacity:0}).to(r,{left:i,duration:.4}).to(s,{left:"0%",duration:.4},0).to(a,{x:"0%",duration:.4},0).set(r,{left:c}).set(e,{opacity:1}).set(n,{x:l}).call(()=>document.querySelectorAll(".goodsSection").forEach(e=>e.classList.remove("nodelay"))).call(doRemoveClassToButtons,[t,o])}function doInitCatalogItemSlider(){var e=new Swiper(".view__small",{direction:"vertical",spaceBetween:9,slidesPerView:3,breakpoints:{768:{spaceBetween:23}}});new Swiper(".view__full",{effect:"fade",slidesPerView:1,spaceBetween:0,navigation:!1,thumbs:{swiper:e}})}function doSelectValueButton(){Array.from(document.querySelectorAll(".details__feature")).forEach(n=>{var s=Array.from(n.querySelectorAll(".details__set-value")),a=n.querySelector(".details__current");s.forEach(e=>{e.addEventListener("click",e=>{var t=e.currentTarget,e=n.classList.contains("details__feature-weight"),o=n.classList.contains("details__feature-color"),r="";if(e)r=t.children[0].value+" гр";else{if(!o)return;r=t.dataset.colorName}requestAnimationFrame(()=>handleSetValueButton(t,s,a,r))})})})}function handleSetValueButton(e,t,o,r){e.classList.contains("selected")||(t.forEach(e=>e.classList.remove("selected")),e.classList.add("selected"),o.textContent=r)}function doToggleDetailsValuesAppearance(){Array.from(document.querySelectorAll(".details__toggle-btn")).forEach(e=>{var t=e.closest(".details__feature");e.addEventListener("click",()=>handleDetailsToggleBtn(t))})}function handleDetailsToggleBtn(e){requestAnimationFrame(()=>{e.classList.toggle("active")})}function doCheckSetValueAmount(){const e=Array.from(document.querySelectorAll(".details__feature-color"));e.forEach(e=>{var t=e.querySelector(".details__toggle-btn"),o=t.children[0],e=e.querySelectorAll(".details__set-value").length;1300<window.innerWidth?doSetToggleBtnAmount(e,t,o,18):768<=window.innerWidth&&window.innerWidth<=1300?doSetToggleBtnAmount(e,t,o,14):doSetToggleBtnAmount(e,t,o,12)})}function doSetToggleBtnAmount(e,t,o,r){r<e?(t.classList.remove("non-overflow"),o.textContent="+"+(e-r+1)):t.classList.add("non-overflow")}function doChangeToggleBtnAmountByResize(){var e=window.matchMedia("(max-width: 767px)"),t=window.matchMedia("(max-width: 1300px)");e.addEventListener("change",doCheckSetValueAmount),t.addEventListener("change",doCheckSetValueAmount)}function doToggleAddToFavoritesBtn(e,o){const t=document.querySelectorAll(e);t.forEach(e=>{const t=e.closest(o);e.addEventListener("click",()=>{t.classList.toggle("addedToFavorites")})})}function doToggleInfoTabs(){var t=document.querySelectorAll(".info__heading-btn"),o=document.querySelectorAll(".info__tab");t.forEach(e=>e.addEventListener("click",e=>handleInfoButtons(e,o,t)))}function handleInfoButtons(e,t,o){var e=e.currentTarget,r=e.dataset.heading,n="";t.forEach(e=>e.classList.contains("hidden")?null:n=e.dataset.tab),r===n||(o.forEach(e=>e.classList.remove("active")),e.classList.add("active"),t.forEach(e=>e.dataset.tab===r?e.classList.remove("hidden"):e.classList.add("hidden")))}function doToggleReviewsPanel(){var e=document.querySelector(".info__reviews-btn"),t=document.querySelector(".add");body=document.body,e.addEventListener("click",e=>{handleInfoReviewsBtn(e,body,t)}),window.matchMedia("(max-width: 767px)").addEventListener("change",e=>{handleResizeForAddBlock(e,body,t)}),document.querySelectorAll(".reviews-close").forEach(e=>e.addEventListener("click",()=>{handleAddBlockCloseBtn(body,t)}))}function handleInfoReviewsBtn(e,t,o){o.classList.add("active"),window.innerWidth<=767?(o.style.maxHeight="100vh",t.classList.add("noscroll")):o.style.maxHeight=o.scrollHeight+"px"}function handleResizeForAddBlock(e,t,o){o.classList.contains("active")&&(e.matches?doSetTo100vh:doSetToScrollHeight)(t,o)}function doSetToScrollHeight(e,t){e.classList.remove("noscroll"),t.style.maxHeight=t.scrollHeight+"px"}function doSetTo100vh(e,t){e.classList.add("noscroll"),t.style.maxHeight="100vh"}function handleAddBlockCloseBtn(e,t){t.style.maxHeight="0",t.classList.remove("active"),e.classList.remove("noscroll")}function checkNewCommentForm(){var t=document.querySelector(".add__form"),o=Array.from(t.querySelectorAll(".rating__input")),r=t.elements.user_name,n=t.elements.email,s=t.elements.raitng,a=t.elements.comment,i=[r,n,s,a];t.addEventListener("submit",e=>{e.preventDefault(),r.validity.valueMissing&&r.classList.add("error"),(n.validity.typeMismatch||n.validity.valueMissing)&&n.classList.add("error"),doCheckRatingInputs(o)||s.classList.add("error"),a.validity.valueMissing&&a.classList.add("error"),checkContainingErrorClassName(i)||(e=document.querySelector(".add"),t.reset(),e.classList.remove("active"),showReviewsPublishMessage())}),doRemoveErrorClassNameByInput(i)}function checkContainingErrorClassName(e){return e.some(e=>e.classList.contains("error"))}function doCheckRatingInputs(e){return e.some(e=>e.checked)}function doRemoveErrorClassNameByInput(e){var{0:e,1:t,2:o,3:r}=e;[e,t,r].forEach(e=>e.addEventListener("input",e=>e.target.classList.remove("error"))),o.addEventListener("input",e=>e.target.closest(".rating__fieldset").classList.remove("error"))}function doInitFileRead(){var o=document.querySelector(".add__images"),r=document.querySelector(".add__img-btn"),n=document.querySelector("#images_input");n.addEventListener("change",()=>{var e=n.files,t=[];for(file of e)file.type.startsWith("image/")&&t.push(file);t.forEach(e=>{var t;o.children.length<6?((t=document.createElement("DIV")).classList.add("add__img"),t.innerHTML=`<img src="${URL.createObjectURL(e)}" alt="фото отзыва"><button class="add__img-remove" type="button" aria-label="Удалить фото отзыва"></button>`,r.before(t),t.querySelector(".add__img-remove").addEventListener("click",e=>handleRemoveImage(e,r,n))):(r.classList.add("disabled"),n.setAttribute("disabled",!0))})})}function addListernerToRemoveBtn(){var t=document.querySelector(".add__img-btn"),o=document.querySelector("#images_input");document.querySelectorAll(".add__img-remove").forEach(e=>e.addEventListener("click",e=>handleRemoveImage(e,t,o)))}function handleRemoveImage(e,t,o){e.target.closest(".add__img").remove(),t.classList.remove("disabled"),o.removeAttribute("disabled")}function doShowOneclick(){var e=document.querySelector(".details__one-click"),t=document.querySelector(".oneclick"),o=document.body;e.addEventListener("click",()=>{requestAnimationFrame(()=>{t.classList.add("active"),o.classList.add("noscroll")})})}function doHideOneclick(){var e=document.querySelectorAll(".oneclick-close"),t=document.querySelector(".oneclick"),o=document.body;e.forEach(e=>e.addEventListener("click",()=>{requestAnimationFrame(()=>{t.classList.remove("active"),o.classList.remove("noscroll")})}))}function checkOneclickForm(){var o=document.querySelector(".oneclick"),r=document.querySelector(".oneclick__form"),n=r.elements.customer_name,s=r.elements.customer_phone,a=[n,s];r.addEventListener("submit",e=>{if(e.preventDefault(),n.validity.valueMissing&&n.classList.add("error"),minPhoneLen=parseInt(s.dataset.minPhoneLength),s.value.length<minPhoneLen&&s.classList.add("error"),!checkContainingErrorClassName(a)){o.classList.remove("active"),showFormSubmitedMessage();const t=Array.from(r.elements);t.forEach(e=>{e.classList.contains("oneclick__input")&&(e.value="")})}}),doRemoveErrorClassNameInOneclick(a)}function doRemoveErrorClassNameInOneclick(e){e.forEach(e=>e.addEventListener("input",e=>e.target.classList.remove("error")))}function doInitMaskInput(){const e=Maska["MaskInput"];new e("[data-maska]")}function doSetCursorToEnd(){document.querySelector(".oneclick__phone").addEventListener("click",e=>{var e=e.target,t=e.value.length;e.setSelectionRange(t,t)})}function doChangeGoodsAmount(e,n){Array.from(document.querySelectorAll(e)).forEach(e=>{var t=e.querySelector(".goods-decrease"),o=e.querySelector(".goods-increase"),r=e.querySelector("input");t.addEventListener("click",()=>{var e=parseInt(r.value);1<e&&(r.value=e-1),n&&doChangeSum(r)}),o.addEventListener("click",()=>{var e=parseInt(r.value);r.value=e+1,n&&doChangeSum(r)})})}function doAddListenersToAllAmountInput(){document.querySelectorAll(".goods-amount input").forEach(e=>e.addEventListener("input",()=>{doChangeSum(e)}))}function doChangeSum(e){var t,o=e.closest(".cart__regular-row"),r=o.querySelector(".cart__price-new"),n=o.querySelector(".cart__price-old"),s=o.querySelector(".cart__sum-new"),o=o.querySelector(".cart__sum-old");""===e.value?(s.textContent="0 ₸",o&&(o.textContent="0 ₸")):(t=parseInt(e.value),e=parseInt(e.value)*parseInt(r.textContent.replaceAll(" ","")),s.textContent=new Intl.NumberFormat("ru-RU").format(e)+"₸",n&&o&&(o.textContent=t*parseInt(n.textContent.replaceAll(" ",""))+"₸",r=t*parseInt(n.textContent.replaceAll(" ","")),o.textContent=new Intl.NumberFormat("ru-RU").format(r)+"₸"))}function doRemoveGoodFromCart(){Array.from(document.querySelectorAll(".cart__remove")).forEach(n=>n.addEventListener("click",()=>{var e=n.closest(".cart__regular-row"),t=e.querySelector(".cart__removing"),o=e.querySelector(".cart__cancel"),r=e.querySelector(".cart__delete-anyway");e.classList.add("deleting"),o.addEventListener("click",()=>e.classList.remove("deleting")),t.addEventListener("animationend",()=>e.remove()),r.addEventListener("click",()=>e.remove())}))}function doClearCart(){var e=document.querySelector(".cart__reset"),t=document.querySelector(".cart__list");e.addEventListener("click",()=>{t.innerHTML=""})}function doInitBrandsSearch(){var e=document.querySelector(".brands-search__input"),t=document.querySelector(".brands-search__clear"),o=document.querySelector(".brands__result"),r=document.querySelector(".brands__wrapper");function n(){Boolean(e.value)?(e.classList.add("active"),t.classList.add("visible")):(e.classList.remove("active"),t.classList.remove("visible"))}function s(){e.value="",e.classList.remove("active"),e.focus(),t.classList.remove("visible"),o.classList.remove("show"),r.classList.remove("hidden")}e.addEventListener("input",()=>requestAnimationFrame(n)),t.addEventListener("click",()=>requestAnimationFrame(s))}function doInitSmoothScroll(){var t=document.getElementById("brands-abc");function o(e){e.preventDefault();var e=e.target;e.classList.contains("brands-inner-link")&&(e=(e=e).getAttribute("href").slice(1),e=document.getElementById(e).getBoundingClientRect().top-160,window.scrollBy({top:e,behavior:"smooth"}))}991<window.innerWidth&&t.addEventListener("click",o),window.matchMedia("(max-width: 991px)").addEventListener("change",function(e){e.matches?t.removeEventListener("click",o):t.addEventListener("click",o)})}function doBrandsSearch(){var t=document.querySelector(".brands__sticky"),o=document.querySelector(".brands-search__input"),r=document.querySelector(".brands__result"),n=document.querySelector(".brands__wrapper"),s=Array.from(document.querySelectorAll(".brands-link")),a=document.querySelector(".brands__result-start"),i=document.querySelector(".brands__result-contains");o.addEventListener("input",()=>{{var e;0<o.value.length?(e=n.getBoundingClientRect().top+window.scrollY-t.scrollHeight,r.classList.contains("show")||window.scrollTo({top:e,behavior:"smooth"}),r.classList.add("show"),n.classList.add("hidden")):(r.classList.remove("show"),n.classList.remove("hidden"))}0<o.value.length&&c(o)});const c=debounce(function(e){a.innerHTML="",i.innerHTML="";var t=e.value.toLowerCase(),e=s.filter(e=>e.textContent.toLowerCase().includes(t)),o=[],r=[];e.forEach(e=>{(e.textContent.toLowerCase().startsWith(t)?o:r).push(e)}),requestAnimationFrame(()=>l(o,"start")),requestAnimationFrame(()=>l(r,"contains"))},400);function l(e,t){var o=document.createDocumentFragment();e.forEach(e=>{var t=document.createElement("LI");t.classList.add("brands__result-item"),t.innerHTML=`
      <a class="brands__result-link" href="${e.getAttribute("href")}">${e.textContent}</a>
      `,o.append(t)}),("start"===t?a:i).append(o)}}function doResetEmptyInputByBlur(){document.querySelectorAll(".goods-amout").forEach(o=>o.addEventListener("blur",()=>{var e,t;""===o.value&&(o.value=1,(e=o.closest(".cart__regular-row"))&&(e.querySelector(".cart__sum-new").textContent=e.querySelector(".cart__price-new").textContent,(t=e.querySelector(".cart__sum-old"))&&(t.textContent=e.querySelector(".cart__price-old").textContent)))}))}function doToggleAddToCartButton(){document.querySelector(".details__add-to-cart").addEventListener("click",()=>document.body.classList.toggle("added-to-cart"))}function doShowAuth(){var e=document.querySelector(".panel__user"),t=document.querySelector(".auth"),o=document.body;e.addEventListener("click",()=>{requestAnimationFrame(()=>{t.classList.add("active"),o.classList.add("noscroll")})})}function doShowRegistration(){var e=document.querySelector(".auth__to-registration"),t=document.querySelector(".auth");e.addEventListener("click",()=>{requestAnimationFrame(()=>{t.classList.remove("signin"),t.classList.add("registration")})})}function doHideAuth(){var e=document.querySelectorAll(".auth-close"),t=document.querySelector(".auth"),o=document.body,r=document.querySelectorAll(".auth__input");e.forEach(e=>e.addEventListener("click",()=>{requestAnimationFrame(()=>handleHideAuth(t,o,r))}))}function handleHideAuth(e,t,o){e.classList.remove("active","registration"),e.classList.add("signin"),t.classList.remove("noscroll"),clearFormInputs(o),o.forEach(e=>e.classList.remove("error"))}function checkAuthForm(){var r=document.querySelector(".auth"),n=document.body;Array.from(document.querySelectorAll(".auth__form")).forEach(e=>{var t=Array.from(e.querySelectorAll(".auth__input")),o=t.filter(e=>e.classList.contains("auth__input--required"));e.addEventListener("submit",e=>{e.preventDefault(),o.forEach(e=>doCheckForm(e,t)),checkContainingErrorClassName(o)||doSubmitAuth(r,n,t)}),doRemoveErrorClassNameInAuth(o)})}function clearFormInputs(e){e.forEach(e=>e.value="")}function doRemoveErrorClassNameInAuth(e){e.forEach(e=>e.addEventListener("input",e=>e.target.classList.remove("error")))}function doSubmitAuth(e,t,o){handleHideAuth(e,t,o)}function doToggleCabinetNav(){var o=Array.from(document.querySelectorAll(".cabinet__nav-btn"));o.forEach(t=>{t.addEventListener("click",e=>{e=e.target;t.classList.contains("active")||handleCabinetNav(o,e)})})}function handleCabinetNav(e,t){e.forEach(e=>e.classList.remove("active")),t.classList.add("active")}function doSavePersonalData(){console.log("all changes saved")}function doToggleCabinetAccordion(){Array.from(document.querySelectorAll(".cabinet__accordion")).forEach(e=>{e.querySelector(".cabinet__orders-top").addEventListener("click",()=>e.classList.toggle("show"))})}function checkRequiredFormInputs(){Array.from(document.querySelectorAll(".form")).forEach(e=>{var t=Array.from(e.querySelectorAll(".input")),o=t.filter(e=>e.classList.contains("input-required"));e.addEventListener("submit",e=>{e.preventDefault(),o.forEach(e=>doCheckForm(e,t)),checkContainingErrorClassName(o)||doSavePersonalData()}),doRemoveErrorClassNameInAuth(o)})}function doCheckForm(e,t){var o;"user_phone"===e.name?(o=parseInt(e.dataset.minPhoneLength),minPhoneLen=!Number.isNaN(o)&&7<o?o:18,e.value.length<minPhoneLen&&e.classList.add("error")):"user_email"===e.name?/^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$/.test(e.value)||e.classList.add("error"):"user_password"===e.name?e.value.length<5&&e.classList.add("error"):"user_password_repeat"===e.name?(o=t.filter(e=>"user_password"===e.name)[0].value,(e.value<5||e.value!==o)&&e.classList.add("error")):e.validity.valueMissing&&e.classList.add("error")}function doChangeInputState(){var e=document.querySelectorAll(".cabinet__input");e.forEach(t=>t.addEventListener("input",()=>{var e=t.parentElement;e.parentElement.classList.remove("focus"),0<t.value.length?e.classList.add("non-empty"):e.classList.remove("non-empty")})),e.forEach(t=>t.addEventListener("blur",e=>{t.parentElement.classList.remove("focus")})),e.forEach(e=>e.addEventListener("focus",()=>{e.parentElement.classList.add("focus")}))}function doClearInput(){var e=document.querySelectorAll(".cabinet__clear");e.forEach(e=>e.addEventListener("click",()=>{e.parentElement.classList.remove("non-empty"),input=e.previousElementSibling,input.focus(),input.value=""})),e.forEach(e=>e.addEventListener("mouseenter",()=>e.parentElement.classList.add("clicked"))),e.forEach(e=>e.addEventListener("mouseleave",()=>e.parentElement.classList.remove("clicked")))}function doSwitchOrderStep(){var e=document.querySelector(".order__info"),t=Array.from(document.querySelectorAll(".order__step")),o=document.querySelector(".order__prev");document.querySelector(".order__next").addEventListener("click",()=>handleOrderNextBtn(e,t)),o.addEventListener("click",()=>handleOrderPrevBtn(e,t))}function handleOrderNextBtn(e,t){var o=t.length-1,r=t.findIndex(e=>e.classList.contains("current")),n=t[r],t=t[r+1],s=document.querySelector(".step-first"),a=Array.from(s.querySelectorAll(".input")),s=a.filter(e=>e.classList.contains("input-required"));0===r&&r!==o?(s.forEach(e=>doCheckForm(e,a)),checkContainingErrorClassName(s)||(e.classList.remove("first-step-is-current"),doSetNextStep(n,t)),doRemoveErrorClassNameInAuth(s)):0<r&&r<o-1?doSetNextStep(n,t):r===o-1&&(e.classList.add("last-step-is-current"),doSetNextStep(n,t))}function doSetNextStep(e,t){e.classList.add("collapse"),e.classList.remove("current"),t.classList.add("current");var o=e.children[1];t.children[1];const r=gsap.timeline();r.to(o,{opacity:0,duration:.2}).to(o,{height:0,duration:.2}).to(t,{opacity:1,height:"auto",overflow:"visible",duration:.2,onStart:()=>t.classList.remove("hidden")},0).set(e,{overflow:"hidden"},0)}function handleOrderPrevBtn(e,t){var o=t.length-1,r=t.findIndex(e=>e.classList.contains("current")),n=t[r],t=t[r-1];r===o&&0!==r?(e.classList.remove("last-step-is-current"),doSetPrevStep(n,t)):1<r&&r<o?doSetPrevStep(n,t):1===r&&(e.classList.add("first-step-is-current"),doSetPrevStep(n,t))}function doSetPrevStep(e,t){e.classList.remove("current"),t.classList.add("current"),t.classList.remove("collapse");var o=t.children[1];const r=gsap.timeline();r.to(e,{opacity:0,duration:.2}).to(e,{duration:.2,height:0,onComplete:()=>e.classList.add("hidden")}).to(o,{opacity:1,height:"auto",duration:.2},0).set(t,{overflow:"visible"},0)}function doCheckOrderPlacementFirstStepInputs(){var e=Array.from(document.querySelectorAll(".step-first")),t=Array.from(e.querySelectorAll(".input")),e=t.filter(e=>e.classList.contains("input-required"));e.forEach(e=>doCheckForm(e,t)),checkContainingErrorClassName(e)||doSavePersonalData(),doRemoveErrorClassNameInAuth(e)}function doInitContentSlider(){new Swiper(".content__slider",{spaceBetween:16,slidesPerView:1.4,slidesOffsetAfter:20,navigation:{prevEl:".content__prev",nextEl:".content__next"},breakpoints:{576:{slidesPerView:2,slidesOffsetAfter:0},768:{spaceBetween:24,slidesPerView:3},1001:{spaceBetween:24,slidesPerView:4}}})}function doInitCompanySlider(){var e=new Swiper(".certificates__slider",{slidesPerView:2,spaceBetween:15,breakpoints:{576:{slidesPerView:3},768:{spaceBetween:24},992:{slidesPerView:4},1301:{slidesPerView:5},1500:{slidesPerView:6}},navigation:{prevEl:".certificates__prev",nextEl:".certificates__next"}});new Swiper(".fullscreen__slider",{effect:"fade",slidesPerView:1,spaceBetween:0,navigation:{prevEl:".certificates__prev",nextEl:".certificates__next"},thumbs:{swiper:e}})}function doShowCertificatesFullscreen(){var e=document.querySelectorAll(".certificates__slide"),t=document.querySelector(".fullscreen"),o=document.body,r=document.querySelector(".fullscreen__close");function n(){t.classList.remove("show"),o.classList.remove("noscroll")}e.forEach(e=>e.addEventListener("click",()=>{t.classList.add("show"),o.classList.add("noscroll")})),r.addEventListener("click",()=>n()),window.addEventListener("keydown",e=>"Escape"===e.key&&n())}function doShowFullscreen(){var s=document.body,e=document.querySelectorAll(".info__reviews-img"),a=document.querySelector(".fullscreen .swiper-wrapper"),i=document.querySelector(".fullscreen"),c=document.querySelector(".fullscreen__close"),l={};e.forEach(e=>e.addEventListener("click",e=>{var t=e.target.closest(".info__reviews-images"),t=Array.from(t.children),o=e.target.src,r=document.createDocumentFragment(),e=(t.forEach(e=>{var t=document.createElement("DIV");t.classList.add("fullscreen__slide","swiper-slide"),t.innerHTML=e.innerHTML,r.append(t)}),a.append(r),Array.from(a.children).findIndex(e=>e.querySelector("img").src===o));function n(){l.destroy(!0,!0),i.classList.remove("show"),s.classList.remove("noscroll"),a.innerHTML=""}e<0&&(e=0),l=new Swiper(".fullscreen__slider",{initialSlide:e,effect:"fade",slidesPerView:1,spaceBetween:0,navigation:{prevEl:".certificates__prev",nextEl:".certificates__next"}}),i.classList.add("show"),s.classList.add("noscroll"),c.addEventListener("click",n),window.addEventListener("keydown",e=>"Escape"===e.key&&n())}))}function showFormSubmitedMessage(){var e=document.querySelector(".form-submited"),t=document.body;e.classList.add("active"),t.classList.add("noscroll")}function hideFormSubmitedMessage(){var e=document.querySelector(".form-submited"),t=document.body;e.classList.remove("active"),t.classList.remove("noscroll")}function handleCloseFormSubmitedMessage(){document.querySelectorAll(".form-submited-close").forEach(e=>e.addEventListener("click",()=>requestAnimationFrame(hideFormSubmitedMessage)))}function showReviewsPublishMessage(){var t=document.body,o=document.querySelector(".review-submited"),e=document.querySelectorAll(".review-submited-close");o.classList.add("active"),t.classList.add("noscroll"),e.forEach(e=>e.addEventListener("click",()=>{o.classList.remove("active"),t.classList.remove("noscroll")}))}function catalogSearchBrannd(){var e=document.querySelector(".filters__search input"),t=Array.from(document.querySelectorAll(".filters__brands .filters__label")),o=document.querySelectorAll(".filters__listName"),r=debounce(()=>catalogSearch(e,t,o),400);e.addEventListener("input",()=>r())}function catalogSearch(e,t,o){var r=e.value.toLowerCase(),n=(0<r.length?o.forEach(e=>e.classList.add("hidden")):o.forEach(e=>e.classList.remove("hidden")),t.filter(e=>e.lastElementChild.textContent.toLowerCase().includes(r)));t.forEach(e=>{n.includes(e)?e.classList.remove("hidden"):e.classList.add("hidden")})}