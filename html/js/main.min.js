...
function doHeaderInit(){const o=document.querySelector(".header__container"),t=document.querySelector(".header__menu"),e=document.querySelector(".header__btn");function n(){o.classList.contains("active")?(o.classList.remove("active"),t.style.maxHeight=0):(o.classList.add("active"),t.style.maxHeight=t.scrollHeight+"px",t.style.opacity=1)}e.addEventListener("click",()=>{requestAnimationFrame(n)});const r=window.matchMedia("(max-width: 1300px)");r.addEventListener("change",function(e){e.matches?(t.style.maxHeight=0,t.style.opacity=0):(o.classList.remove("active"),t.style.maxHeight=t.scrollHeight+"px",t.style.opacity=1)})}function doPanelInit(){const e=document.querySelectorAll(".panel__input"),o=document.querySelectorAll(".panel__clear");function t(e){const o=e.nextElementSibling;e.value="",e.classList.remove("active"),o.classList.remove("visible")}e.forEach(e=>e.addEventListener("input",r=>requestAnimationFrame(()=>{{var e=r;const o=Boolean(e.target.value),t=e.target,n=t.nextElementSibling;return void(o?(t.classList.add("active"),n.classList.add("visible")):(t.classList.remove("active"),n.classList.remove("visible")))}}))),o.forEach(e=>e.addEventListener("click",n=>requestAnimationFrame(()=>{{var e;const o=n.target.closest(".panel__clear"),t=o.previousElementSibling;return t.value="",t.classList.remove("active"),t.focus(),void o.classList.remove("visible")}})));const n=document.getElementById("show-menu"),r=document.getElementById("menu-overlay"),a=document.getElementById("menu"),i=document.querySelector(".panel__showCategories");n.addEventListener("click",()=>{requestAnimationFrame(()=>{[r,a,i].forEach(e=>e.classList.toggle("active")),e.forEach(e=>t(e))})}),r.addEventListener("click",()=>{requestAnimationFrame(()=>{[r,a,i].forEach(e=>e.classList.remove("active")),e.forEach(e=>t(e))})})}function doIntroSectionInit(){const o=new Swiper("#intro-slider-left",{loop:!0,grab:!1,allowTouchMove:!1,autoplay:{delay:5e3,disableOnInteraction:!1},pagination:{el:".intro__pagination",clickable:!0},navigation:{nextEl:".intro__next",prevEl:".intro__prev"}}),t=new Swiper("#intro-slider-center",{loop:!0,grab:!1,allowTouchMove:!0,autoplay:{delay:5e3,disableOnInteraction:!1},pagination:{el:".intro__pagination",clickable:!0},navigation:{nextEl:".intro__next",prevEl:".intro__prev"},breakpoints:{1301:{allowTouchMove:!1}}}),n=new Swiper("#intro-slider-right",{loop:!0,grab:!1,allowTouchMove:!1,autoplay:{delay:5e3,disableOnInteraction:!1},pagination:{el:".intro__pagination",clickable:!0},navigation:{nextEl:".intro__next",prevEl:".intro__prev"}}),r=Array.from(document.querySelectorAll(".intro__pagination span"));t.on("slideChange",function(){var e=t.realIndex;r.forEach(e=>{e.classList.remove("swiper-pagination-bullet-active")}),r[e].classList.add("swiper-pagination-bullet-active")});const e=window.matchMedia("(max-width: 1300px)"),a=(e.addEventListener("change",e=>{e.matches||(e=t.realIndex,t.slideToLoop(e,0),n.slideToLoop(e,0),o.slideToLoop(e,0))}),document.querySelector(".brandsSection__autoscroll")),i=document.querySelector(".promotionsSection__autoscroll"),c=document.querySelector(".map__autoscroll");[a].forEach(e=>{new Splide(e,{type:"loop",arrows:!1,pagination:!1,perPage:3,gap:"800px",breakpoints:{1700:{gap:"900px"},1600:{gap:"400px"},1400:{gap:"600px"},992:{gap:"200px",perPage:2},767:{perPage:3,gap:"100px"},650:{gap:"150px"},575:{perPage:2,gap:"100px"},400:{gap:"170px"}},autoScroll:{speed:1,pauseOnHover:!1,pauseOnFocus:!1}}).mount(window.splide.Extensions)}),[i].forEach(e=>{new Splide(e,{type:"loop",arrows:!1,pagination:!1,perPage:3,gap:"400px",breakpoints:{1700:{gap:"600px"},1600:{gap:"200px"},1300:{gap:"300px"},1150:{gap:"500px"},992:{gap:"350px"},767:{gap:"60px"},575:{gap:"230px"}},autoScroll:{speed:1,pauseOnHover:!1,pauseOnFocus:!1}}).mount(window.splide.Extensions)}),[c].forEach(e=>{new Splide(e,{type:"loop",arrows:!1,pagination:!1,perPage:2,gap:"1700px",breakpoints:{1600:{gap:"1000px"},1400:{gap:"1100px"},1300:{gap:"1200px"},1100:{gap:"1250px"},992:{gap:"950px"},767:{gap:"500px"}},autoScroll:{speed:1,pauseOnHover:!1,pauseOnFocus:!1}}).mount(window.splide.Extensions)})}function doInitMap(){ymaps.ready(function(){var o=[51.158562572612595,71.43921449999996];if(ymaps){let e=new ymaps.Map("map-section-wrapper",{center:o,zoom:17});o=new ymaps.Placemark(o,{},{iconLayout:"default#image",iconImageHref:"images/map-current-mark.svg",iconImageSize:[40,40],iconImageOffset:[-15,-5]});e.controls.remove("geolocationControl"),e.controls.remove("searchControl"),e.controls.remove("trafficControl"),e.controls.remove("typeSelector"),e.controls.remove("fullscreenControl"),e.controls.remove("zoomControl"),e.controls.remove("rulerControl"),e.geoObjects.add(o)}})}function doRemoveMapOverlayByClick(){const e=document.querySelector(".mapSection__overlay");e.addEventListener("click",()=>{e.classList.add("hidden")})}function doInitMapStoresSelect(){var e=document.querySelector(".map__stores");new Choices(e,{silent:!1,searchEnabled:!1})}function doAddMapStoresListener(){const e=document.querySelector(".map__stores"),o=document.querySelector(".map__description");e.addEventListener("change",e=>{o.classList.remove("hidden")})}function doHideMapDescription(){const e=document.querySelector(".map__description"),o=document.querySelector(".map__close");o.addEventListener("click",()=>{e.classList.add("hidden")})}function doToggleFooterAccordion(){window.innerWidth<=575&&doAddListenersToFooterAccordions();const e=window.matchMedia("(max-width: 575px)");e.addEventListener("change",e=>{(e.matches?doAddListenersToFooterAccordions:doRemoveListenersToFooterAccordions)()})}function handleFooterAccordions(e){const o=e.target.closest(".footer__column"),t=o.children[1];o.classList.toggle("active");e=o.classList.contains("active");t.style.maxHeight=e?t.scrollHeight+"px":null}function doAddListenersToFooterAccordions(){const e=document.querySelectorAll(".footer__column");e.forEach(e=>{const o=e.children[0];o.addEventListener("click",handleFooterAccordions)})}function doRemoveListenersToFooterAccordions(){const e=document.querySelectorAll(".footer__column");e.forEach(e=>{const o=e.children[0],t=e.children[1];o.removeEventListener("click",handleFooterAccordions),e.classList.remove("active"),t.style.maxHeight=null})}function doToggleFavoritesIcons(){const e=document.querySelectorAll(".goodsCard__addToFavorites");e.forEach(e=>e.addEventListener("click",e=>{const o=e.target.closest(".goodsCard__addToFavorites");o.classList.toggle("addedToFavorites")}))}function doParallaxPromotionsSection(){const e=document.querySelector(".discountedProducts");var o=e.querySelectorAll(".goodsCard__item");const t=gsap.timeline();t.from(".textLline__first",{x:"200px",scrollTrigger:{trigger:".discountedProducts",start:"top bottom",end:"bottom bottom",scrub:!0}}).from(".textLline__second",{x:"-200px",scrollTrigger:{trigger:".discountedProducts",start:"top bottom",end:"bottom bottom",scrub:!0}},0).from(o[0],{y:"-232px",ease:Power2.easeOut,scrollTrigger:{trigger:".goodsCard__wrapper",start:"+=200px bottom",end:"bottom+=400px bottom",scrub:!0}},0).from(o[2],{y:"-98px",ease:Power2.easeOut,scrollTrigger:{trigger:".goodsCard__wrapper",start:"+=200px bottom",end:"bottom+=200px bottom",scrub:!0}},0)}function doSortMenuLogic(){const e=document.body,n=document.querySelector(".options__sortToggleBtn");var o=document.querySelector(".options__overlay");const t=Array.from(document.querySelectorAll(".options__sortList li button")),r=[].concat(o,...t),a=document.querySelector(".options__current");function i(){e.classList.remove("sort-list-open"),r.forEach(e=>e.removeEventListener("click",i))}function c(e){var o=n.dataset.sortType,e=e.target.closest(".options__sortList button"),t=e.dataset.sortType;o!==t&&(a.textContent=e.children[0].textContent,n.dataset.sortType=t)}n.addEventListener("click",()=>{e.classList.add("sort-list-open"),r.forEach(e=>e.addEventListener("click",i)),t.forEach(e=>e.addEventListener("click",c))})}document.addEventListener("DOMContentLoaded",function(e){doHeaderInit(),doPanelInit(),doToggleFooterAccordion(),gsap.registerPlugin(ScrollTrigger);document.querySelector(".intro")&&(doIntroSectionInit(),"undefined"!=typeof ymaps&&null!==ymaps&&doInitMap(),doRemoveMapOverlayByClick(),doInitMapStoresSelect(),doAddMapStoresListener(),doHideMapDescription(),doToggleFavoritesIcons(),doParallaxPromotionsSection());var o=document.querySelector(".catalog-page");o&&(doToggleFavoritesIcons(),doSortMenuLogic())});