...
function doHeaderInit(){const t=document.querySelector(".header__container"),n=document.querySelector(".header__menu"),e=document.querySelector(".header__btn");function a(){t.classList.contains("active")?(t.classList.remove("active"),n.style.maxHeight=0):(t.classList.add("active"),n.style.maxHeight=n.scrollHeight+"px",n.style.opacity=1)}e.addEventListener("click",()=>{requestAnimationFrame(a)});const i=window.matchMedia("(max-width: 1300px)");i.addEventListener("change",function(e){e.matches?(n.style.maxHeight=0,n.style.opacity=0):(t.classList.remove("active"),n.style.maxHeight=n.scrollHeight+"px",n.style.opacity=1)})}function doPanelInit(){const e=document.querySelectorAll(".panel__input"),t=document.querySelectorAll(".panel__clear");function n(e){const t=e.nextElementSibling;e.value="",e.classList.remove("active"),t.classList.remove("visible")}e.forEach(e=>e.addEventListener("input",i=>requestAnimationFrame(()=>{{var e=i;const t=Boolean(e.target.value),n=e.target,a=n.nextElementSibling;return void(t?(n.classList.add("active"),a.classList.add("visible")):(n.classList.remove("active"),a.classList.remove("visible")))}}))),t.forEach(e=>e.addEventListener("click",a=>requestAnimationFrame(()=>{{var e;const t=a.target.closest(".panel__clear"),n=t.previousElementSibling;return n.value="",n.classList.remove("active"),n.focus(),void t.classList.remove("visible")}})));const a=document.getElementById("show-menu"),i=document.getElementById("menu-overlay"),o=document.getElementById("menu"),l=document.querySelector(".panel__showCategories");a.addEventListener("click",()=>{requestAnimationFrame(()=>{[i,o,l].forEach(e=>e.classList.toggle("active")),e.forEach(e=>n(e))})}),i.addEventListener("click",()=>{requestAnimationFrame(()=>{[i,o,l].forEach(e=>e.classList.remove("active")),e.forEach(e=>n(e))})})}function doIntroSectionInit(){const t=new Swiper("#intro-slider-left",{loop:!0,grab:!1,allowTouchMove:!1,autoplay:{delay:5e3,disableOnInteraction:!1},hashNavigation:{watchState:!0},pagination:{el:".intro__pagination",clickable:!0},navigation:{nextEl:".intro__next",prevEl:".intro__prev"}}),n=new Swiper("#intro-slider-center",{loop:!0,grab:!1,allowTouchMove:!0,autoplay:{delay:5e3,disableOnInteraction:!1},hashNavigation:{watchState:!0},pagination:{el:".intro__pagination",clickable:!0},navigation:{nextEl:".intro__next",prevEl:".intro__prev"},breakpoints:{1301:{allowTouchMove:!1}}}),a=new Swiper("#intro-slider-right",{loop:!0,grab:!1,allowTouchMove:!1,autoplay:{delay:5e3,disableOnInteraction:!1},hashNavigation:{watchState:!0},pagination:{el:".intro__pagination",clickable:!0},navigation:{nextEl:".intro__next",prevEl:".intro__prev"}}),i=Array.from(document.querySelectorAll(".intro__pagination span"));n.on("slideChange",function(){var e=n.realIndex;i.forEach(e=>{e.classList.remove("swiper-pagination-bullet-active")}),i[e].classList.add("swiper-pagination-bullet-active")});const e=window.matchMedia("(max-width: 1300px)");e.addEventListener("change",e=>{e.matches||(e=n.realIndex,n.slideToLoop(e,0),a.slideToLoop(e,0),t.slideToLoop(e,0))})}document.addEventListener("DOMContentLoaded",function(e){doHeaderInit(),doPanelInit(),document.querySelector(".intro")&&doIntroSectionInit();const t=document.querySelectorAll(".autoscroll__block");t.forEach(e=>{new Splide(e,{type:"loop",arrows:!1,pagination:!1,perPage:2,gap:"120px",breakpoints:{767:{perPage:3,gap:"200px"},575:{perPage:2}},autoScroll:{speed:.5,pauseOnHover:!1,pauseOnFocus:!1}}).mount(window.splide.Extensions)})});