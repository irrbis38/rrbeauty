...
function doStartFirstScreenAnimation(){const e=gsap.timeline();e.set(".header",{opacity:1},0).set(".intro",{opacity:1},0).from(".header__container",{delay:.5,opacity:0,y:"-10px",duration:.4}).from(".header__container .container",{opacity:0,y:5,duration:.8}).from(".panel__line",{width:0,duration:.5},"-=0.4").from(".panel__title",{opacity:0,y:-5,duration:.4},"-=0.4").from(".panel__nav",{opacity:0,x:-30,duration:.7},"-=0.1").from(".panel__menu",{opacity:0,x:30,duration:.7},"<").from(".intro__block--center",{opacity:0,y:50,scale:.9,duration:.7},"<").from(".intro__block--left",{opacity:0,x:-50,duration:.4},"-=0.2").from(".intro__block--right",{opacity:0,x:50,duration:.4},"<").from(".intro__nav",{opacity:0,duration:.4,onComplete:()=>initIntroSlider()},3).from(".intro__pagination",{opacity:0,y:10,duration:.4})}function doHeaderInit(){const t=document.querySelector(".header__container"),o=document.querySelector(".header__menu"),e=document.querySelector(".header__btn"),n=document.querySelector(".header__overlay");function r(){t.classList.contains("active")?(t.classList.remove("active"),o.style.maxHeight=0,n.classList.remove("show")):(t.classList.add("active"),o.style.maxHeight=o.scrollHeight+"px",o.style.opacity=1,n.classList.add("show"))}e.addEventListener("click",()=>{requestAnimationFrame(r)}),n.addEventListener("click",()=>{t.classList.remove("active"),o.style.maxHeight=0,n.classList.remove("show")});const i=window.matchMedia("(max-width: 1300px)");i.addEventListener("change",function(e){e.matches?(o.style.maxHeight=0,o.style.opacity=0):(t.classList.remove("active"),o.style.maxHeight=o.scrollHeight+"px",o.style.opacity=1)})}function doPanelInit(){const e=document.querySelectorAll(".panel__input"),t=document.querySelectorAll(".panel__clear");function o(e){const t=e.nextElementSibling;e.value="",e.classList.remove("active"),t.classList.remove("visible")}e.forEach(e=>e.addEventListener("input",r=>requestAnimationFrame(()=>{{var e=r;const t=Boolean(e.target.value),o=e.target,n=o.nextElementSibling;return void(t?(o.classList.add("active"),n.classList.add("visible")):(o.classList.remove("active"),n.classList.remove("visible")))}}))),t.forEach(e=>e.addEventListener("click",n=>requestAnimationFrame(()=>{{var e;const t=n.target.closest(".panel__clear"),o=t.previousElementSibling;return o.value="",o.classList.remove("active"),o.focus(),void t.classList.remove("visible")}})));const n=document.body,r=document.getElementById("show-menu"),i=document.getElementById("menu-overlay"),s=document.getElementById("menu"),a=document.querySelector(".panel__showCategories");r.addEventListener("click",()=>{requestAnimationFrame(()=>{[i,s,a].forEach(e=>e.classList.toggle("active")),n.classList.toggle("lock"),e.forEach(e=>o(e))})}),i.addEventListener("click",()=>{requestAnimationFrame(()=>{[i,s,a].forEach(e=>e.classList.remove("active")),n.classList.remove("lock"),e.forEach(e=>o(e))})})}async function doInitMap(){ymaps.ready(function(){var t=[51.158562572612595,71.43921449999996];if(ymaps){let e=new ymaps.Map("map-section-wrapper",{center:t,zoom:17});t=new ymaps.Placemark(t,{},{iconLayout:"default#image",iconImageHref:"images/map-current-mark.svg",iconImageSize:[40,40],iconImageOffset:[-15,-5]});e.controls.remove("geolocationControl"),e.controls.remove("searchControl"),e.controls.remove("trafficControl"),e.controls.remove("typeSelector"),e.controls.remove("fullscreenControl"),e.controls.remove("zoomControl"),e.controls.remove("rulerControl"),e.geoObjects.add(t)}})}function doRemoveMapOverlayByClick(){const e=document.querySelector(".mapSection__overlay");e.addEventListener("click",()=>{e.classList.add("hidden")})}function doInitMapStoresSelect(){var e=document.querySelector(".map__stores");new Choices(e,{silent:!1,searchEnabled:!1})}function doAddMapStoresListener(){const e=document.querySelector(".map__stores"),t=document.querySelector(".map__description");e.addEventListener("change",e=>{t.classList.remove("hidden")})}function doHideMapDescription(){const e=document.querySelector(".map__description"),t=document.querySelector(".map__close");t.addEventListener("click",()=>{e.classList.add("hidden")})}function doToggleFooterAccordion(){window.innerWidth<=575&&doAddListenersToFooterAccordions();const e=window.matchMedia("(max-width: 575px)");e.addEventListener("change",e=>{(e.matches?doAddListenersToFooterAccordions:doRemoveListenersToFooterAccordions)()})}function handleFooterAccordions(e){const t=e.target.closest(".footer__column"),o=t.children[1];t.classList.toggle("active");e=t.classList.contains("active");o.style.maxHeight=e?o.scrollHeight+"px":null}function doAddListenersToFooterAccordions(){const e=document.querySelectorAll(".footer__column");e.forEach(e=>{const t=e.children[0];t.addEventListener("click",handleFooterAccordions)})}function doRemoveListenersToFooterAccordions(){const e=document.querySelectorAll(".footer__column");e.forEach(e=>{const t=e.children[0],o=e.children[1];t.removeEventListener("click",handleFooterAccordions),e.classList.remove("active"),o.style.maxHeight=null})}function doToggleFavoritesIcons(){const e=document.querySelectorAll(".goodsCard__addToFavorites");e.forEach(e=>e.addEventListener("click",e=>{const t=e.target.closest(".goodsCard__item");t.classList.toggle("addedToFavorites")}))}function doSortMenuLogic(){const e=document.body,n=document.querySelector(".options__sortToggleBtn");var t=document.querySelector(".options__overlay");const o=Array.from(document.querySelectorAll(".options__sortList li button")),r=[].concat(t,...o),i=document.querySelector(".options__current");function s(){e.classList.remove("sort-list-open"),r.forEach(e=>e.removeEventListener("click",s))}function a(e){var t=n.dataset.sortType,e=e.target.closest(".options__sortList button"),o=e.dataset.sortType;t!==o&&(i.textContent=e.children[0].textContent,n.dataset.sortType=o)}n.addEventListener("click",()=>{e.classList.add("sort-list-open"),r.forEach(e=>e.addEventListener("click",s)),o.forEach(e=>e.addEventListener("click",a))})}function doFiltersMenuLogic(){const e=document.querySelector(".options__nav"),t=document.querySelector(".options__filtersToggleBtn"),o=Array.from(document.querySelectorAll(".filters__button")),n=document.querySelector(".filters");t.addEventListener("click",()=>{e.classList.toggle("filters-opened"),n.classList.toggle("filters-opened")}),o.forEach(o=>o.addEventListener("click",()=>{const e=o.closest(".filters__block"),t=e.querySelector(".filters__wrapper");e.classList.toggle("filters-block-opened"),e.classList.contains("filters-block-opened")?t.style.maxHeight=t.scrollHeight+"px":t.style.maxHeight=null}))}function handleAllInputRange(){const e=document.querySelectorAll(".filters__range");function t(e){let t,o;var n=e.target.classList.contains("filters__inputMin"),r=e.target.classList.contains("filters__inputMax");n?(t=e.target,o=t.nextElementSibling):r&&(o=e.target,t=o.previousElementSibling);const i=t.closest(".filters__wrapper"),s=i.querySelector(".filters__track"),a=i.querySelector(".filters__valueMin"),l=i.querySelector(".filters__valueMax");var r=parseInt(t.value),e=parseInt(o.value);let c;c=parseInt(o.max)-parseInt(t.min)<=10?1:parseInt(o.max)-parseInt(t.min)<=100?10:50,e-r<c?n?t.value=e-c:o.value=r+c:(a.value=""+r,l.value=""+e,n=100*(r-t.min)/(t.max-t.min)+"%",r=100*(o.max-e)/(o.max-o.min)+"%",s.style.left=n,s.style.right=r)}e.forEach(e=>e.addEventListener("input",t));const o=Array.from(document.querySelectorAll(".filters__valueMin")),n=Array.from(document.querySelectorAll(".filters__valueMax"));function r(e){const t=e.target,o=t.closest(".filters__wrapper"),n=o.querySelector(".filters__inputMin"),r=o.querySelector(".filters__inputMax");var e=t.classList.contains("filters__valueMin"),i=t.classList.contains("filters__valueMax");const s=o.querySelector(".filters__track");let a,l=(a=r.max-n.min<=10?1:r.max-n.min<=100?10:50,parseInt(t.value));function c(){var e=100*(l-n.min)/(n.max-n.min)+"%";s.style.left=e}function d(){var e=100*(r.max-l)/(r.max-r.min)+"%";s.style.right=e}e&&(l<t.min||Number.isNaN(l)?(t.value="",n.value=parseInt(t.min),s.style.left=0):(l>r.value-a?(t.value=parseInt(r.value)-a,n.value=parseInt(r.value)-a):(t.value=l,n.value=l),c())),i&&(l>parseInt(t.max)||Number.isNaN(l)?(t.value="",r.value=parseInt(t.max),s.style.right="0"):(l<parseInt(n.value)+a?(t.value=parseInt(n.value)+a,r.value=parseInt(n.value)+a):(t.value=l,r.value=l),d()))}o.forEach(e=>e.addEventListener("change",r)),n.forEach(e=>e.addEventListener("change",r)),o.forEach(e=>e.addEventListener("blur",r)),n.forEach(e=>e.addEventListener("blur",r))}function doToggleBrandDescription(){const e=document.querySelector(".brandDescription"),t=document.querySelector(".brandDescription__title"),o=document.querySelector(".brandDescription__info");t.addEventListener("click",()=>{e.classList.toggle("brand-description-opened"),e.classList.contains("brand-description-opened")?o.style.maxHeight=o.scrollHeight+"px":o.style.maxHeight=null})}function initParallaxPromotionsSection(){const e=document.querySelector(".discountedProducts"),o=e.querySelectorAll(".goodsCard__item");let t=gsap.matchMedia();t.add({isDesktop:"(min-width: 992px) and (prefers-reduced-motion: no-preference)",isMobile:"(max-width: 991px) and (prefers-reduced-motion: no-preference)"},e=>{e=e.conditions.isDesktop;const t=gsap.timeline();return e&&t.from(o[0],{y:"-232px",ease:Power1.easeOut,scrollTrigger:{trigger:".goodsCard__wrapper",start:"top 90%",end:"bottom 90%",scrub:!0}}).from(o[2],{y:"-98px",ease:Power4.easeOut,scrollTrigger:{trigger:".goodsCard__wrapper",start:"+=200px bottom",end:"bottom+=200px bottom",scrub:!0}},"-=2"),()=>{}})}function doAnimationByScrollMainPage(){var e=Array.from(document.querySelectorAll(".animated__title")),t=Array.from(document.querySelectorAll(".popularCategories__img")),o=Array.from(document.querySelectorAll(".popularCategories__name")),n=Array.from(document.querySelectorAll(".brandsSection__item")),r=Array.from(document.querySelectorAll(".over")),i=Array.from(document.querySelectorAll(".promotionsSection__block--first")),s=Array.from(document.querySelectorAll(".promotionsSection__block--second")),a=Array.from(document.querySelectorAll(".promotionsSection__block--first .promotionsSection__item:first-child")),l=Array.from(document.querySelectorAll(".promotionsSection__block--second .promotionsSection__item")),c=Array.from(document.querySelectorAll(".goodsSection .goodsCard__slide")),d=Array.from(document.querySelectorAll(".footer__main-wrapper"));const u=[].concat(e,t,o,n,r,i,s,a,l,c,d);u.forEach((e,t)=>{ScrollTrigger.create({trigger:e,start:"top 90%",once:!0,toggleClass:"animate"})})}function doFooterAnimationByScroll(){var e=Array.from(document.querySelectorAll(".footer__copyright"));const t=[].concat(e);t.forEach((e,t)=>{ScrollTrigger.create({trigger:e,start:"top bottom",once:!0,toggleClass:"animate"})})}function initAnimateTextPromotionsSection(){let e=gsap.matchMedia();e.add({isDesktop:"(min-width: 768px) and (prefers-reduced-motion: no-preference)",isMobile:"(max-width: 767px) and (prefers-reduced-motion: no-preference)"},e=>{e=e.conditions.isDesktop;const t=gsap.timeline();e&&t.from(".textLline__first",{x:"200px",scrollTrigger:{trigger:".discountedProducts",start:"top bottom",end:"bottom bottom",scrub:!0}}).from(".textLline__second",{x:"-200px",scrollTrigger:{trigger:".discountedProducts",start:"top bottom",end:"bottom bottom",scrub:!0}},0)})}function initIntroSlider(){const e=document.querySelector(".intro"),t=e.querySelectorAll(".intro__slider"),o=e.querySelector(".intro__prev"),n=e.querySelector(".intro__next"),r=(t.forEach(e=>{const t=e.querySelectorAll(".intro__slide")[2];t.classList.add("current-slide"),doAddInitSettingsToIntroSlider(e)}),{intro:e,intro_sliders:t,prev_btn:o,next_btn:n});let i=function(){const e=gsap.timeline();return e.to(".intro__paginationItem.active span",{x:"0%",duration:5},0).to(".intro__paginationItem span",{x:"-100%",duration:0,onComplete:()=>handleIntroBtn("to_left",r)})}();i.repeat(-1),[o,n].forEach(e=>{let t="";t=e.classList.contains("intro__next")?"to_left":"to_right",e.addEventListener("click",()=>{requestAnimationFrame(()=>{handleIntroBtn(t,r)}),i.restart()})})}function handleIntroBtn(t,o){const e=o["intro_sliders"];e.forEach(e=>{doIntroSliderAnimation(e,o,t)})}function doReplaceIntroSliderElements(...e){const[t,o]=e,n=t.querySelector(".intro__sliderWrapper");e=Array.from(t.querySelectorAll(".intro__slide"));if("to_left"===o){const r=e[2],i=r.cloneNode(!0),s=(i.classList.remove("current-slide"),e[0]);s.remove(),n.append(i)}else{const a=e[3],l=a.cloneNode(!0),c=(l.classList.remove("current-slide"),e[e.length-1]);c.remove(),n.prepend(l)}}function doAddInitSettingsToIntroSlider(e){const t=Array.from(e.querySelectorAll(".intro__slide"));t.forEach((e,t)=>{t<2?(e.style.left="-100%",e.children[0].style.transform="translate(90%, 0)"):2===t?(e.style.left="0",e.children[0].style.transform="translate(0, 0)"):(e.style.left="100%",e.children[0].style.transform="translate(-90%, 0)")})}function doIntroSliderAnimation(e,t,o){var{prev_btn:t,next_btn:n}=t,r=e.querySelector(".current-slide");const d=e.querySelectorAll(".intro__slide");var u=r.children[0];let i=null,s=null,a,l,c;c="to_left"===o?(i=r.nextElementSibling,s=i.children[0],a="-5%",l="-100%","90%"):(i=r.previousElementSibling,s=i.children[0],a="5%",l="100%","-90%"),gsapAnimationIntroSlider({slider:e,direction:o,prev_btn:t,next_btn:n,currentSlide:r,currentSlideInner:u,newSlide:i,newSlideInner:s,firstCurrentSlideOffsset:a,lastCurrentSlideOffset:l,lastCurrentSlideInnerOffset:c}),d.forEach(e=>e.classList.remove("current-slide")),i.classList.add("current-slide")}function gsapAnimationIntroSlider(e){var{slider:e,direction:t,prev_btn:o,next_btn:n,currentSlide:r,currentSlideInner:i,newSlide:s,newSlideInner:a,firstCurrentSlideOffsset:l,lastCurrentSlideOffset:c,lastCurrentSlideInnerOffset:d}=e;const u=gsap.timeline();return u.call(doAddClassToButtons,[o,n],0).set(r,{zIndex:1}).set(s,{zIndex:2}).to(r,{left:l,duration:.4}).to(s,{left:"0%",duration:.4},0).to(a,{x:"0%",duration:.4},0).set(r,{left:c}).set(i,{x:d}).call(doRemoveClassToButtons,[o,n]).call(doReplaceIntroSliderElements,[e,t]).call(doAddInitSettingsToIntroSlider,[e])}function initPromotionsSectionSlider(){doCheckSlidesAmount({counter:0,section:document.querySelector(".promotionsSection"),sectionItemsClassName:".promotionsSection__item",sliders_wrappers:Array.from(document.querySelectorAll(".promotionsSection__sliderWrapper")),prev_btn:document.querySelector(".promotionsSection__nav .intro__prev"),next_btn:document.querySelector(".promotionsSection__nav .intro__next")})}function initAllGoodsSectionsSliders(){var e=Array.from(document.querySelectorAll(".goodsSection")),t=document.querySelector(".discountedProducts");sections=t?[].concat(e,[t]):e,sections.forEach(e=>{var t=Array.from(e.querySelectorAll(".goodsCard__sliderWrapper")),o=e.querySelector(".intro__prev"),n=e.querySelector(".intro__next");doCheckSlidesAmount({counter:0,section:e,sectionItemsClassName:".goodsCard__item",sliders_wrappers:t,prev_btn:o,next_btn:n})})}function doCheckSlidesAmount(e){let{counter:t,section:o,sectionItemsClassName:n,sliders_wrappers:r,prev_btn:i,next_btn:s}=e;let a=[];r.forEach(e=>{a.push(e.children.length)});var l=Math.min(...a);if(1<l){const e={counter:t,section:o,sliders_wrappers:r,prev_btn:i,next_btn:s,slidesAmount:l,sectionItemsClassName:n};doInitGeneralSliderLogic(e)}else o.classList.add("slider-start","slider-finish")}function doInitGeneralSliderLogic(e){let{counter:t,section:o,sliders_wrappers:n,prev_btn:r,next_btn:i,slidesAmount:s,sectionItemsClassName:a}=e;768<=window.innerWidth&&(n.forEach(e=>doSetInitSettings(e)),l());const d=window.matchMedia("(max-width: 767px)");function l(){i.addEventListener("click",c),r.addEventListener("click",c)}function c(e){if(e.currentTarget.classList.contains("intro__next"))n.forEach(e=>handleSliderNavButtons(e,t,r,i,"next")),t+=1,doCheckCounter(t,o,s);else if(e.currentTarget.classList.contains("intro__prev"))n.forEach(e=>handleSliderNavButtons(e,t,r,i,"prev")),--t,doCheckCounter(t,o,s)}d.addEventListener("change",e=>{e.matches?(t=0,o.classList.add("slider-start"),o.classList.remove("slider-finish"),n.forEach(e=>doSetInitSettings(e)),i.removeEventListener("click",c),r.removeEventListener("click",c)):(doRemoveAllAddedElements(Array.from(o.querySelectorAll(a)),4),l())})}function doRemoveAllAddedElements(e,o){e.forEach((e,t)=>{o<=t&&e.remove()})}function doSetInitSettings(e){const t=Array.from(e.children);t.forEach((e,t)=>{0===t?(e.style.left="0%",Array.from(e.children).forEach(e=>e.style.transform="translate(0, 0)")):(e.style.left="100%",Array.from(e.children).forEach(e=>e.style.transform="translate(-90%, 0)"))})}function doCheckCounter(e,t,o){0===e?(t.classList.add("slider-start"),t.classList.remove("slider-finish")):0<e&&2===o?(t.classList.add("slider-finish"),t.classList.remove("slider-start")):0<e&&e<o-1?t.classList.remove("slider-start","slider-finish"):(t.classList.remove("slider-start"),t.classList.add("slider-finish"))}function doAddClassToButtons(...e){e.forEach(e=>e.classList.add("disabled"))}function doRemoveClassToButtons(...e){e.forEach(e=>e.classList.remove("disabled"))}function handleSliderNavButtons(e,t,o,d,n){var e=e.children,r=e[t],i=r.children,u=i[1];let s=null,a,l,c;c="next"===n?(s=e[t+1],a="-5%",l="-100%","90%"):(s=e[t-1],a="5%",l="100%","-90%");n=s.children;u?gsapAnimationForPromotionsSlider({prev_btn:o,next_btn:d,currentSlideName:u,currentSlide:r,currentSlideInner:i,newSlide:s,newSlideInner:n,firstCurrentSlideOffsset:a,lastCurrentSlideOffset:l,lastCurrentSlideInnerOffset:c}):gsapAnimationForGoodsSectionSlider({prev_btn:o,next_btn:d,currentSlide:r,currentSlideInner:i,newSlide:s,newSlideInner:n,firstCurrentSlideOffsset:a,lastCurrentSlideOffset:l,lastCurrentSlideInnerOffset:c})}function gsapAnimationForPromotionsSlider(e){var{prev_btn:e,next_btn:t,currentSlideName:o,currentSlide:n,currentSlideInner:r,newSlide:i,newSlideInner:s,firstCurrentSlideOffsset:a,lastCurrentSlideOffset:l,lastCurrentSlideInnerOffset:c}=e;const d=gsap.timeline();return d.call(doAddClassToButtons,[e,t],0).set(o,{opacity:0}).set(n,{zIndex:1}).set(i,{zIndex:2}).to(n,{left:a,duration:.4}).to(i,{left:"0%",duration:.4},0).to(s,{x:"0%",duration:.4},0).set(n,{left:l}).set(o,{opacity:1}).set(r,{x:c}).call(doRemoveClassToButtons,[e,t])}function gsapAnimationForGoodsSectionSlider(e){const{prev_btn:t,next_btn:o,currentSlide:n,currentSlideInner:r,newSlide:i,newSlideInner:s,firstCurrentSlideOffsset:a,lastCurrentSlideOffset:l,lastCurrentSlideInnerOffset:c}=e;e=[n.querySelector(".goodsCard__price"),n.querySelector(".goodsCard__name"),n.querySelector(".goodsCard__about"),n.querySelector(".goodsCard__addToCart")];const d=gsap.timeline();return d.call(doAddClassToButtons,[t,o],0).call(()=>document.querySelectorAll(".goodsSection").forEach(e=>e.classList.add("nodelay"))).set(n,{zIndex:1}).set(i,{zIndex:2}).set(e,{opacity:0}).to(n,{left:a,duration:.4}).to(i,{left:"0%",duration:.4},0).to(s,{x:"0%",duration:.4},0).set(n,{left:l}).set(e,{opacity:1}).set(r,{x:c}).call(()=>document.querySelectorAll(".goodsSection").forEach(e=>e.classList.remove("nodelay"))).call(doRemoveClassToButtons,[t,o])}function doInitCatalogItemSlider(){var e=new Swiper(".view__small",{direction:"vertical",spaceBetween:9,slidesPerView:3,navigation:!1,breakpoints:{768:{spaceBetween:23}}});new Swiper(".view__full",{effect:"fade",slidesPerView:1,spaceBetween:0,navigation:!1,thumbs:{swiper:e}})}function doSelectValueButton(){Array.from(document.querySelectorAll(".details__feature")).forEach(r=>{var i=Array.from(r.querySelectorAll(".details__set-value")),s=r.querySelector(".details__current");i.forEach(e=>{e.addEventListener("click",e=>{var t=e.currentTarget,e=r.classList.contains("details__feature-weight"),o=r.classList.contains("details__feature-color"),n="";if(e)n=t.textContent+" гр";else{if(!o)return;n=t.dataset.colorName}requestAnimationFrame(()=>handleSetValueButton(t,i,s,n))})})})}function handleSetValueButton(e,t,o,n){e.classList.contains("selected")||(t.forEach(e=>e.classList.remove("selected")),e.classList.add("selected"),o.textContent=n)}function doToggleDetailsValuesAppearance(){Array.from(document.querySelectorAll(".details__toggle-btn")).forEach(e=>{var t=e.closest(".details__feature");e.addEventListener("click",()=>handleDetailsToggleBtn(t))})}function handleDetailsToggleBtn(e){requestAnimationFrame(()=>{e.classList.toggle("active")})}function doCheckSetValueAmount(){const e=Array.from(document.querySelectorAll(".details__feature-color"));e.forEach(e=>{var t=e.querySelector(".details__toggle-btn"),o=t.children[0],e=e.querySelectorAll(".details__set-value").length;1300<window.innerWidth?doSetToggleBtnAmount(e,t,o,18):768<=window.innerWidth&&window.innerWidth<=1300?doSetToggleBtnAmount(e,t,o,14):doSetToggleBtnAmount(e,t,o,12)})}function doSetToggleBtnAmount(e,t,o,n){n<e?(t.classList.remove("non-overflow"),o.textContent="+"+(e-n+1)):t.classList.add("non-overflow")}function doChangeToggleBtnAmountByResize(){var e=window.matchMedia("(max-width: 767px)"),t=window.matchMedia("(max-width: 1300px)");e.addEventListener("change",doCheckSetValueAmount),t.addEventListener("change",doCheckSetValueAmount)}function doToggleAddToFavoritesBtn(e,o){const t=document.querySelectorAll(e);t.forEach(e=>{const t=e.closest(o);e.addEventListener("click",()=>{t.classList.toggle("addedToFavorites")})})}function doToggleInfoTabs(){var t=document.querySelectorAll(".info__heading-btn"),o=document.querySelectorAll(".info__tab");t.forEach(e=>e.addEventListener("click",e=>handleInfoButtons(e,o,t)))}function handleInfoButtons(e,t,o){var e=e.currentTarget,n=e.dataset.heading,r="";t.forEach(e=>e.classList.contains("hidden")?null:r=e.dataset.tab),n===r||(o.forEach(e=>e.classList.remove("active")),e.classList.add("active"),t.forEach(e=>e.dataset.tab===n?e.classList.remove("hidden"):e.classList.add("hidden")))}function doToggleReviewsPanel(){var e=document.querySelector(".info__reviews-btn"),t=document.querySelector(".add");body=document.body,e.addEventListener("click",e=>{handleInfoReviewsBtn(e,body,t)}),window.matchMedia("(max-width: 767px)").addEventListener("change",e=>{handleResizeForAddBlock(e,body,t)}),document.querySelectorAll(".reviews-close").forEach(e=>e.addEventListener("click",()=>{handleAddBlockCloseBtn(body,t)}))}function handleInfoReviewsBtn(e,t,o){o.classList.add("active"),window.innerWidth<=767?(o.style.maxHeight="100vh",t.classList.add("noscroll")):o.style.maxHeight=o.scrollHeight+"px"}function handleResizeForAddBlock(e,t,o){o.classList.contains("active")&&(e.matches?doSetTo100vh:doSetToScrollHeight)(t,o)}function doSetToScrollHeight(e,t){e.classList.remove("noscroll"),t.style.maxHeight=t.scrollHeight+"px"}function doSetTo100vh(e,t){e.classList.add("noscroll"),t.style.maxHeight="100vh"}function handleAddBlockCloseBtn(e,t){t.style.maxHeight="0",t.classList.remove("active"),e.classList.remove("noscroll")}function checkNewCommentForm(){var t=document.querySelector(".add__form"),o=Array.from(t.querySelectorAll(".rating__input")),n=t.elements.user_name,r=t.elements.email,i=t.elements.raitng,s=t.elements.comment,a=[n,r,i,s];t.addEventListener("submit",e=>{n.validity.valueMissing&&n.classList.add("error"),(r.validity.typeMismatch||r.validity.valueMissing)&&r.classList.add("error"),doCheckRatingInputs(o)||i.classList.add("error"),s.validity.valueMissing&&s.classList.add("error"),checkContainingErrorClassName(a)?e.preventDefault():t.submit()}),doRemoveErrorClassNameByInput(a)}function checkContainingErrorClassName(e){return e.some(e=>e.classList.contains("error"))}function doCheckRatingInputs(e){return e.some(e=>e.checked)}function doRemoveErrorClassNameByInput(e){var{0:e,1:t,2:o,3:n}=e;[e,t,n].forEach(e=>e.addEventListener("input",e=>e.target.classList.remove("error"))),o.addEventListener("input",e=>e.target.closest(".rating__fieldset").classList.remove("error"))}function doShowOneclick(){var e=document.querySelector(".details__one-click"),t=document.querySelector(".oneclick"),o=document.body;e.addEventListener("click",()=>{requestAnimationFrame(()=>{t.classList.add("active"),o.classList.add("noscroll")})})}function doHideOneclick(){var e=document.querySelectorAll(".oneclick-close"),t=document.querySelector(".oneclick"),o=document.body;e.forEach(e=>e.addEventListener("click",()=>{requestAnimationFrame(()=>{t.classList.remove("active","submited"),o.classList.remove("noscroll")})}))}function checkOneclickForm(){var o=document.querySelector(".oneclick"),n=document.querySelector(".oneclick__form"),r=n.elements.customer_name,i=n.elements.customer_phone,s=[r,i];n.addEventListener("submit",e=>{if(e.preventDefault(),r.validity.valueMissing&&r.classList.add("error"),minPhoneLen=parseInt(i.dataset.minPhoneLength),i.value.length<minPhoneLen&&i.classList.add("error"),!checkContainingErrorClassName(s)){o.classList.add("submited");const t=Array.from(n.elements);t.forEach(e=>{e.classList.contains("oneclick__input")&&(e.value="")})}}),doRemoveErrorClassNameInOneclick(s)}function doRemoveErrorClassNameInOneclick(e){e.forEach(e=>e.addEventListener("input",e=>e.target.classList.remove("error")))}function doInitMaskInput(){const e=Maska["MaskInput"];new e("[data-maska]")}function doSetCursorToEnd(){document.querySelector(".oneclick__phone").addEventListener("click",e=>{var e=e.target,t=e.value.length;e.setSelectionRange(t,t)})}function doChangeGoodsAmount(e,r){Array.from(document.querySelectorAll(e)).forEach(e=>{var t=e.querySelector(".goods-decrease"),o=e.querySelector(".goods-increase"),n=e.querySelector("input");t.addEventListener("click",()=>{var e=parseInt(n.value);1<e&&(n.value=e-1),r&&doChangeSum(n)}),o.addEventListener("click",()=>{var e=parseInt(n.value);n.value=e+1,r&&doChangeSum(n)})})}function doAddListenersToAllAmountInput(){document.querySelectorAll(".goods-amount input").forEach(e=>e.addEventListener("input",()=>{doChangeSum(e)}))}function doChangeSum(e){var t,o=e.closest(".cart__regular-row"),n=o.querySelector(".cart__price-new"),r=o.querySelector(".cart__price-old"),i=o.querySelector(".cart__sum-new"),o=o.querySelector(".cart__sum-old");""===e.value?(i.textContent="0 ₸",o&&(o.textContent="0 ₸")):(t=parseInt(e.value),e=parseInt(e.value)*parseInt(n.textContent.replaceAll(" ","")),i.textContent=new Intl.NumberFormat("ru-RU").format(e)+"₸",r&&o&&(o.textContent=t*parseInt(r.textContent.replaceAll(" ",""))+"₸",n=t*parseInt(r.textContent.replaceAll(" ","")),o.textContent=new Intl.NumberFormat("ru-RU").format(n)+"₸"))}function doRemoveGoodFromCart(){Array.from(document.querySelectorAll(".cart__remove")).forEach(r=>r.addEventListener("click",()=>{var e=r.closest(".cart__regular-row"),t=e.querySelector(".cart__removing"),o=e.querySelector(".cart__cancel"),n=e.querySelector(".cart__delete-anyway");e.classList.add("deleting"),o.addEventListener("click",()=>e.classList.remove("deleting")),t.addEventListener("animationend",()=>e.remove()),n.addEventListener("click",()=>e.remove())}))}function doClearCart(){var e=document.querySelector(".cart__reset"),t=document.querySelector(".cart__list");e.addEventListener("click",()=>{t.innerHTML=""})}function doInitBrandsSearch(){const e=document.querySelector(".brands-search__input"),t=document.querySelector(".brands-search__clear");function o(){Boolean(e.value)?(e.classList.add("active"),t.classList.add("visible")):(e.classList.remove("active"),t.classList.remove("visible"))}function n(){e.value="",e.classList.remove("active"),e.focus(),t.classList.remove("visible")}e.addEventListener("input",()=>requestAnimationFrame(o)),t.addEventListener("click",()=>requestAnimationFrame(n))}function doResetEmptyInputByBlur(){document.querySelectorAll(".goods-amout").forEach(o=>o.addEventListener("blur",()=>{var e,t;""===o.value&&(o.value=1,(e=o.closest(".cart__regular-row"))&&(e.querySelector(".cart__sum-new").textContent=e.querySelector(".cart__price-new").textContent,(t=e.querySelector(".cart__sum-old"))&&(t.textContent=e.querySelector(".cart__price-old").textContent)))}))}document.addEventListener("DOMContentLoaded",function(e){doHeaderInit(),doPanelInit(),doToggleFooterAccordion(),gsap.registerPlugin(ScrollTrigger);document.querySelector(".intro")&&(doStartFirstScreenAnimation(),doAnimationByScrollMainPage(),doFooterAnimationByScroll(),doRemoveMapOverlayByClick(),doInitMapStoresSelect(),doAddMapStoresListener(),doHideMapDescription(),doToggleFavoritesIcons(),initParallaxPromotionsSection(),initAnimateTextPromotionsSection(),initPromotionsSectionSlider(),initAllGoodsSectionsSliders(),"undefined"!=typeof ymaps&&null!==ymaps&&setTimeout(doInitMap,0));var t=document.querySelector(".catalog-page"),t=(t&&(doToggleFavoritesIcons(),doSortMenuLogic(),doFiltersMenuLogic(),handleAllInputRange()),document.querySelector(".catalog-brand-page")),t=(t&&(doToggleFavoritesIcons(),doSortMenuLogic(),doFiltersMenuLogic(),handleAllInputRange(),doToggleBrandDescription()),document.querySelector(".catalog-favorites-page")),t=(t&&doToggleFavoritesIcons(),document.querySelector(".catalog-search-result-page")),t=(t&&doToggleFavoritesIcons(),document.querySelector(".catalog-item")),t=(t&&(doInitCatalogItemSlider(),doSelectValueButton(),doToggleDetailsValuesAppearance(),doCheckSetValueAmount(),doChangeToggleBtnAmountByResize(),doToggleAddToFavoritesBtn(".details__add-to-favorites",".item"),doToggleInfoTabs(),doChangeGoodsAmount(".goods-amount",!1),doToggleReviewsPanel(),checkNewCommentForm(),doShowOneclick(),doHideOneclick(),checkOneclickForm(),doInitMaskInput(),doSetCursorToEnd(),initAllGoodsSectionsSliders(),doToggleFavoritesIcons(),doResetEmptyInputByBlur()),document.querySelector(".cart-page")),t=(t&&(doToggleAddToFavoritesBtn(".cart__add-to-favorites",".cart__regular-row"),doChangeGoodsAmount(".goods-amount",!0),doAddListenersToAllAmountInput(),doRemoveGoodFromCart(),doClearCart(),doResetEmptyInputByBlur()),document.querySelector(".brands-page"));t&&doInitBrandsSearch()});